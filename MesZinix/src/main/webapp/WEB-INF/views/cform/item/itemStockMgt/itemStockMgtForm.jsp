...
<%-- 			<tr>
				...
				<!-- 부품코드 -->
					...
					<td>
						<input type="text" id="itemId" class="btn-input" name="itemId" placeholder="<spring:message code = "pop_searchAuto"></spring:message>" readonly />			<!-- 조회시 자동입력 -->
						<button class="k-button k-primary" type="button" id="item_search_btn" onclick= "lfn_itemInfoPop_Open();" style="display:none;"><spring:message code = "btn_search"/></button>			<!-- 조회 -->
					</td>
				<!-- 부품유형 -->
					<td class="td-right-title"><i class="fas fa-caret-right"></i><spring:message code = "col_itemType"></spring:message> : </td>
					<td><input type="text" id="itemType" name="itemType" format="selBox" msg="item_type" readonly /></td>
				</tr>
				<tr> 
				<!-- 부품명 -->
...
<%--				<td> 부품 총 재고량: </td>
				...
				<tr>
					<td><i class="fas fa-caret-right"></i><spring:message code = "col_itemStandard"></spring:message> : </td>
					<td colspan="3"><input type="text" id="itemStdStr01" name="itemStdStr01" readonly/></td>
				</tr>
<%-- 				<tr class="pop_detail_info">
				...
				<!-- 무게 -->
					...
					<td><input type="text" id="itemStd04" name="itemStd04" format="numeric" readonly /></td>
				<!-- 단위 -->
					<td class="td-right-title"><i class="fas fa-caret-right left-caret"></i><spring:message code = "col_unit"></spring:message> :</td>
					<td><input type="text" id="itemUnit" name="itemUnit" format="selBox" msg="comn_unit" readonly /></td>
				</tr>
				<tr class="pop_detail_info">
				...
				<tr> <!--20305.07 JJW 펼치기 숨기기 버튼  -->
					<td colspan="4" class="pop_detail_btn_area" style="padding-top:15px;"> <!-- style="text-align:center;", 패딩 값 공통css에서 적용되므로 인라인스타일을 이용해 값 설정 -->
...
<%-- 				<tr>
				...
				<!-- 부품개별코드 -->
					...
					<td>
						<input type="text" id="itemMgtId" name="itemMgtId" placeholder="<spring:message code = "pop_autoInput"></spring:message>" readonly />			<!-- 자동입력 -->
					</td>
				<!-- 부품개별구분 -->
					<td class="td-right-title"><i class="fas fa-caret-right"></i><spring:message code = "col_itemIndivDiv"></spring:message> : </td>
					<td>
						<input type="text" id="itemMgtType" name="itemMgtType" format="text" readonly />
					</td>
				</tr>
				<tr>
				<!-- 개별 재고량 -->
					...
					<td>
						<input type="text" id="itemStock" name="itemStock" format="numeric" readonly >
					</td>
				<!-- 제조일자 -->
					<td class="td-right-title"><i class="fas fa-caret-right"></i><spring:message code = "col_manufactDate"></spring:message> : </td>
					<td>
						<input id="itemMfgDate" name="itemMfgDate" format="datepicker" />
					</td>
				</tr>
				<tr>
				<!-- 설명 -->
...
<div style="display:none;">
	<div id="jtePopAddForm">
		<form id = "jtePopAddForm_form" class="itemStockMgtForm-popsc">
			...
			<colgroup>
				...
				<!-- 업무구분 -->
					...
					<td>
						<input type="text" id="itemQtyTarget" name="itemQtyTarget" format="text" readonly />
					</td>
				<!-- 수량 -->
					<td class="td-right-title"><i class="fas fa-caret-right left-caret"></i><spring:message code = "col_quantity"></spring:message> : </td>
					<td><input type="text" id="itemQtyTotal" name="itemQtyTotal" format = "currency" /></td>
				</tr>
				<tr>
				<!-- 등록일 -->
					<td><i class="fas fa-caret-right"></i><spring:message code = "col_registDate"></spring:message> : </td>
					<td><input type="text" id="itemQtyDate" name="itemQtyDate" format="datepicker" /></td>
				<!-- 등록자 -->
					...
					<td>
						...
						<button class="k-button k-primary" type="button"  onclick= "lfn_addFormUserPop_open()"><spring:message code = "btn_search"/></button>			<!-- 조회 -->
					</td>
				</tr>
				<tr>
				<!-- 설명 -->
		...
		<div class="itemStockMgtForm final-btn-area" style="text-align:center;">
...
this.lfn_jteSgGrd_setGrd = function(){
	...
	*/
	...
	//3.
	lfo_common.ctrlUrl = "/cform/item/itemStockMgt";
	...
	lfo_common.crud  = {
		...
		update:{url:"/insertItemStock", auth:"", openFunc: "", callback:lfn_popSave}
	};
	...
	lfo_common.columns = [
		...
		{field: "itemStock", format: "{0:n0}", attributes : { style : "text-align : right;"}, title:gfn_getMsg("col_indivStockQty"), width: "110px"},								//개별부품재고량
		{field: "itemPackageStock", format: "{0:n0}", attributes : { style : "text-align : right;"}, title:gfn_getMsg("col_packQuan"), width: "110px"},								//개별부품포장수량
...
*/
	...
	//3.
	lfo_popGrd.ctrlUrl = "/cform/item/itemStockMgt";
	...
	lfo_popGrd.columns = [
		...
		{field: "itemQtyTotal", format:"{0:n0}", attributes : { style : "text-align : right;"}, title:gfn_getMsg("col_quantity"), width: "100px"},						//수량
