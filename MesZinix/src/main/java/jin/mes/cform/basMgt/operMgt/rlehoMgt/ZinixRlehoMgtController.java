...
public class ZinixRlehoMgtController extends BaseController {

	@Autowired
	ZinixRlehoMgtService placeService;
	
	@RequestMapping("getPlaceTree")
	public ResponseEntity<Object> getPlaceTree(@ModelAttribute("placeDto") ZinixRlehoMgtDto placeDto) {
		return new ResponseEntity<Object>(placeService.getPlaceTree(placeDto), HttpStatus.OK);
	}
	
	@RequestMapping("getPlaceList")
	public ModelMap getPlaceList(ModelMap model, @ModelAttribute("placeDto") ZinixRlehoMgtDto placeDto) {
	...
	@ResponseBody
	public int setPlaceSave(@RequestBody ZinixRlehoMgtDto placeDto) {
		return placeService.setPlaceSave(placeDto);
	}
	
	@RequestMapping("/setPlaceDelete")
	@ResponseBody
	public int setPlaceDelete(@RequestBody List<ZinixRlehoMgtDto> placeList) {
