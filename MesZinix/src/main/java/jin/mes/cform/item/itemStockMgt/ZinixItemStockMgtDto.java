...
@NoArgsConstructor
public class ZinixItemStockMgtDto extends BaseVo{
	
	private static final long serialVersionUID = -7223763972842869911L;

	//수량관리(품목관리)
	public ZinixItemStockMgtDto(String itemId, String itemMgtId, String itemMgtType, String itemMfgDate, int itemStock, int itemPackageStock,String description) {
		this.itemId = itemId;
	...
	//사용기록
	public ZinixItemStockMgtDto(String itemId, String itemMgtId, int itemQtyTotal, String itemQtyTarget, String itemQtyTargetCode, String itemQtyDate, String itemQtyUser) {
		this.itemId = itemId;
		this.itemMgtId = itemMgtId;
