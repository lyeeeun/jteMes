...
<!--    Font CSS    -->
		<link href="<c:url value='/resources/mes/font/nanumgothic.css'/>" rel="shortcut icon">
<!-- 	라이브버리 CSS -->
...
<!-- 공통 CSS -->	
	<link href="<c:url value='/static/common/util/timeTo.css'/>" type="text/css" rel="stylesheet">
	<link href="<c:url value='/resources/mes/css/util/fontawesome/css/all.css'/>" rel="stylesheet" type="text/css">

<!-- 전주원 주임 작업 CSS -->
	<link href="<c:url value='/static/css/kendoui/kendotheme_jjw0228.css'/>" rel="stylesheet">
	<link href="<c:url value='/static/css/jqueryui/jquery-ui_jjw.css'/>" rel="stylesheet">
	<link href="<c:url value='/static/css/jqueryui/jquery-ui_jjw.theme.css'/>" rel="stylesheet">
	<link href="<c:url value='/static/css/kendoui/kendo.default.min_jjw.css'/>" rel="stylesheet">
	<link href="<c:url value='/static/css/kendoui/kendo.common.min_jjw.css'/>" rel="stylesheet">
	<link href="<c:url value='/resources/mes/css/theme/theme1.css'/>" rel="stylesheet">
	<link href="<c:url value='/resources/mes/css/theme/theme1_jjw.css'/>" rel="stylesheet">
	<link href="<c:url value='/resources/mes/css/util/fontawesome/css/all_jjw.css'/>" rel="stylesheet" type="text/css"> 

<!-- 이윤민 주임 작업 CSS -->
<%-- 	<link href="<c:url value='/resources/mes/css/util/fontawesome/css/all_lym.css'/>" rel="stylesheet" type="text/css">
	<link href="<c:url value='/static/css/jqueryui/jquery-ui_lym.css'/>" rel="stylesheet">
	<link href="<c:url value='/static/css/jqueryui/jquery-ui.theme_lym.css'/>" rel="stylesheet"> 
	<link href="<c:url value='/static/css/kendoui/kendo.default.min_lym.css'/>" rel="stylesheet">
	<link href="<c:url value='/static/css/kendoui/kendo.common.min_lym.css'/>" rel="stylesheet">
	<link href="<c:url value='/static/css/kendoui/kendo_theme_200227_03_lym.css'/>" rel="stylesheet">	
	<link href="<c:url value='/resources/mes/css/theme/theme1.css'/>" rel="stylesheet">
	<link href="<c:url value='/resources/mes/css/theme/theme_lym.css'/>" rel="stylesheet">	 --%>
...
<!-- 라이브러리 js -->
	...
	<!--언어정보 -->
	<script src="/resources/mes/js/cultures/kendo.culture.ko-KR.js"></script>
<!-- 	<script src="/resources/mes/js/cultures/kendo.culture.en-US.js"></script> -->
	...
	<!-- 공통 js	 -->
	<script src="<c:url value='/resources/mes/js/frame/libFrame.js'/>"></script>
	<script src="<c:url value='/resources/mes/js/frame/libUtil.js'/>"></script>
	<script src="<c:url value='/resources/mes/js/frame/libTabs.js'/>"></script>
	<script src="<c:url value='/resources/mes/js/frame/libTrans.js'/>"></script>
	<script src="<c:url value='/resources/mes/js/frame/libContent.js'/>"></script>
	<script src="<c:url value='/resources/mes/js/pop/libPop.js'/>"></script>
	<script src="<c:url value='/resources/mes/js/pop/libPopTree.js'/>"></script>
	<script src="<c:url value='/resources/mes/js/pop/msgPop.js'/>"></script>
...
// 		});
		...
		setTimeout(function(){
			...
			if(gfn_getDate(gfn_getDate(new Date(), "M", -5), gfn_getDate(userInfo.rows[0].pwChangeAt)) < 0) {
	...
	var goMenuToBody = function(menuInfo/* , menuType, msgView */, data, force){
		...
		if(typeof menuInfo == "object"){
			...
			try{
				...
				$.ajax({
					async:false,
					url : "/form/basMgt/devtol/pageLog/setPageLog",
					type: "POST",
					traditional :true,
...
<sec:authentication var="principal" property="principal"/>
	...
	<div style="display:none;">		<!-- 200429 libUtil.js에서 팝업창 높이 변경_LYM&JJW -->
	...
	<div style="display:none;">		
		<div id="jtePwChangeForm">
			<form id="jtePwChangeForm_form">
				<table style="width:100%;" id="jtePwChangeForm_master" class="tabMain_jtePwChangeForm">
				<colgroup>
					<col class="Config-col-left">
					<col class="Config-col-right">
				</colgroup>
