...
<div style="display:none;">
	<div id="jtePopForm">
		...
		<div id="jtePopForm_grid" class="mtrlOdcursitMgtForm"></div>
	</div>
</div>
		...
		<!-- 수령정보 -->
			...
			<colgroup> <!-- 15 25 15 25 완료정보 조회 버튼 때문에 1행 추가-->
				...
				<!-- 자재명 -->
					...
					<td colspan="4">
						<input type="text" id="mtrlNm" class="center-input" name="mtrlNm" readonly/>
				...
				<!-- 업체명 -->
					...
					<td colspan="4">
						<input type="text" id="compNm" class="center-input" name="compNm" readonly/>
...
this.lfn_jtePop_open = function(mode, selectedItem){
	var options = {
		...
		height: "580px", // 200512 JJW 그리드 더블클릭 팝업 (발주주문서) 높이 500px -> 590px; 590->580px 200821 youmi
		id : lfo_common.popId, 
...
*/
	...
	lfo_popGrd.columns = [
		...
		{field: "incomingInspection", editable: function(){return false;}, title:gfn_getMsg("col_checkList"), width:"95px",		
			template : function(rows) {
				return '<button class="k-button k-primary" type="button" onclick = "gfn_inspectPop(\'NEW\', \'incommingInspect\', \'pop_incommingInspect\', \'' + rows.mtrlOrderId + '\') " style="width:60px;">' + "<spring:message code = "col_checkList" />" + '</button>';					//내역보기
			}
		},		
		...
		{field: "mtrlId", title:gfn_getMsg("col_mtrlCd"), width: 100},
...
this.lfn_mtrlOrderCheckPop_open = function(target, mode){
	var options = {
		...
		height: "565px", // 200512 JJW 수령확인 팝업 높이 400px -> 700px,(POP용이면 다시 600으로 고쳐야함) 600px -> 200819 youmi 555
		id : lfo_popGrd.popId, 
...
this.lfn_mtrlBadGrd_open = function(mode, selectedItem){
	var options = {
		...
		height: "340px", // 200512 JJW 불량품 관리 팝업 높이 250px -> 330px _ 200807 youmi 330->340
