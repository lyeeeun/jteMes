...
<div id="grid-content" class="rlehoMgtForm" style="width: 100%;">
	<div id="jteMasterTree" class="rlehoMgtForm left-contents jteMasterTree"></div>
	...
	<div id="jteSubGrid" class="rlehoMgtForm right-contents jteSubGrid"></div>
</div>
		...
		<form id="jtePopForm_form" class="rlehoMgtForm">
			...
			<colgroup>
				...
				<!-- 위치코드 -->
					...
					<td colspan="5"><input type="text" id="placeId" class="center-input" name="placeId" placeholder="<spring:message code = "pop_autoInput"></spring:message>" readonly /></td>			<!-- 자동생성 -->
				</tr>
				<tr>
				<!-- 위치명 -->
					<td><i class="fas fa-caret-right"></i><spring:message code = "col_placeNm"></spring:message> :  </td>
					<td colspan="5">
						<input type="text" id="placeNm" class="center-input" name="placeNm" format="text"/>
					</td>
<%-- 					<td>	
				...
				<!-- 관리자 -->
					...
					<td>
						<input type="text" id="placeManagerNm" class="left-input btn-input" name="placeManagerNm" format="text" readonly/>
					...
					<td>
						<button class="k-button k-primary search-btn" type="button" onclick="lfn_userInfoPop_Open(lfn_userInfoPop_callback)">
							<spring:message code ="btn_search"></spring:message>
						</button>
					</td>
					<td class="td-right-title"><i class="fas fa-caret-right"></i><spring:message code ="col_sequence"></spring:message> :  </td>
					<td colspan="2">
						<input id="placeSeq" class="right-input" name="placeSeq" format="currency"/>
					</td>
				</tr>
				
				
				<tr>
					<td><i class="fas fa-caret-right"></i>예비1(숫자) :  </td>
					<td colspan="2">
						<input type="text" id="placeStd01" class="left-input" name="placeStd01" format="numeral"/>
					</td>
					<td class="td-right-title"><i class="fas fa-caret-right"></i>예비2(숫자) :  </td>
					<td colspan="2">
						<input type="text" id="placeStd02" class="right-input" name="placeStd02" format="numeral"/>
					</td>
				</tr>
					
				<tr>
				<td><i class="fas fa-caret-right"></i>예비1(문자) :  </td>
					<td colspan="2">
						<input type="text" id="placeStrStd01" class="left-input" name="placeStrStd01" format="text"/>
					</td>
					<td class="td-right-title"><i class="fas fa-caret-right"></i>예비2(문자) :  </td>
					<td colspan="2">
						<input type="text" id="placeStrStd02" class="right-input" name="placeStrStd02" format="text"/>
					</td>
				</tr>
				...
				<!-- 설명 -->
					...
					<td colspan="5"><input type="text" id="description" class="center-input" name="description" format="text"/></td>
				</tr>
		...
		transport: {
			...
			parameterMap: function(data, type){
				...
				return {
					...
					placeParent : $("#jteMasterTree_hidSelected").val()
					}
				}
			}
		},		
...
this.lfn_jtePop_open = function(mode,selectedItem){
	...
	var options = {
			modal:true, 
			width: "700px", 
			height: "394px",  /** 200428 첫번째 팝업 height 변경_LYM 290으로 / JJW 310 / 201016_youmi 430->307 / 201022 JJW 307-> 425 / 201027 YUMI 425->394**/ 
			id:"jtePopForm", 
			title:"", 
			workCd:mode, 
			bdSeq:"",
