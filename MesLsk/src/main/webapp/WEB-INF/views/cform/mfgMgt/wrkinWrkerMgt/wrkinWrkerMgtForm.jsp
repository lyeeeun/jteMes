...
this.lfn_jteRoutingAll_setGrd = function(){
	...
	//3.
	lfo_routingAll.ctrlUrl = "/cform/mfgMgt/wrkinWrkerMgt"
...
this.lfn_jteEquipToolPop_setGrd = function(){
	...
	//3.
	lfo_equipTool.ctrlUrl = "/cform/facilMgt/facilToolMgt"
...
this.lfn_jtePopGrd_delete_callback = function(resultObj){
	...
	$.ajax({
		async:false,
		url : "/cform/mfgMgt/wrkinWrkerMgt/setEqmtToolDelete",
		type: "POST",
...
this.lfn_workStartPop_Open = function(){
	...
	lfo_prodWorkStart = {
		...
		ctrlUrl : "/cform/mfgMgt/wrkinWrkerMgt",
		crud : {
...
this.lfn_mtrlChkPop_mtGridSet = function(){
	...
	//3.
	lfo_MtMtrlChk.ctrlUrl = "/cform/mfgMgt/wrkinWrkerMgt"
	...
	lfo_MtMtrlChk.columns = [
		...
		{field: "bomTargetCnt", format:"{0:n0}", title : gfn_getMsg("col_needQty"), width: "120px"},			//필요수량
...
this.lfn_mtrlChkPop_sbGridSet = function(mode, selectedItem){
	...
	//3.
	lfo_SbMtrlChk.ctrlUrl = "/cform/mtrl/mtrlMgt"
	...
	lfo_SbMtrlChk.columns = [
		...
		{field: "mtrlNm", title:gfn_getMsg("col_mtrlNm"), width: "120px"},														//자재명
		{field: "mtrlMgtCnt", format: "{0:n0}", title:gfn_getMsg("col_mtrlQty"), width: "120px"},								//자재수량
...
this.lfn_mtrlUseDetail_gridSet = function(){
	...
	//3.
	lfo_mtrlUseDetail.ctrlUrl = "/cform/mfgMgt/wrkinWrkerMgt"
...
this.lfn_mtrlUseBadList_gridSet = function(target){
	...
	//3.
	lfo_mtrlUseBad.ctrlUrl = "/cform/mfgMgt/wrkinWrkerMgt"
	...
	lfo_mtrlUseBad.crud  = {
		...
		create : {url:"/cform/qualMgt/infergodsMgt/setMtrlBadSave", openFunc : lfn_mtrlUseBadSavePop_open, callback : lfn_mtrlUseBadSavePop_Save},
		update : {url:"/cform/qualMgt/infergodsMgt/setMtrlBadSave", callback : lfn_mtrlUseBadSavePop_Save}
	};
...
this.lfn_mtrlUseBadList_devItem_gridSet = function(){
	...
	lfo_mtrlUseBad.crud  = {
		...
		//다른 컨트롤러에 있는 서비스를 호출하기 위하여 풀경로 매핑
		create : {url:"/cform/qualMgt/infergodsMgt/setMtrlBadSave", openFunc : lfn_mtrlUseBadSavePop_devItem_open, callback : lfn_mtrlUseBadSavePop_devItem_Save},
		update : {url:"/cform/qualMgt/infergodsMgt/setMtrlBadSave", callback : lfn_mtrlUseBadSavePop_devItem_Save}
	};
...
this.lfn_itemBadListPop_gridSet = function(){
	...
	//3.
	lfo_itemBad.ctrlUrl = "/cform/qualMgt/infergodsMgt"
