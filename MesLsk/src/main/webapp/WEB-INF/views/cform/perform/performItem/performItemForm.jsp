...
<!-- 마스터 그리드 영역 -->
<div class="performItemForm" style="width:100%;">
	<div class="performItemForm search-btn-area" style="width:100%; background:#f0f5ff; padding:15px 0 15px 0; margin:10px 0 5px 0;">
	<!-- 일간 -->
		<input class="k-radio" type="radio" name="target" value="day" checked><span class="radio-span"><spring:message code = "pop_day"></spring:message></span>
	<!-- 월간 -->
		<input class="k-radio" type="radio" name="target" value="month"><span class="radio-span"><spring:message code = "pop_month"></spring:message></span>
	<!-- 연간 -->
		<input class="k-radio" type="radio" name="target" value="year"><span class="radio-span"><spring:message code = "pop_year"></spring:message></span>
	</div>
