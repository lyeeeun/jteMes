...
<div style="display:none;">
	...
	<!-- 라우팅 조회 -->
		<div class="pop_title"><spring:message code = "mn_processInfo"></spring:message></div>
...
this.lfn_jteSgGrd_setGrd = function(){
	...
	*/
	...
	lfo_prcesQual.columns = [
		{field: "badId",title: gfn_getMsg("col_badId"), width: "140px"},
		{field: "badCode", template:"# var item = gfn_isNull(gfn_getCode(badCode))== true ? '기초코드 없음' : gfn_getMsg('bc_'+ gfn_getCode(badCode).cdVal , gfn_getCode(badCode).cdNm) # #= item #",
				title:gfn_getMsg("col_badCause"), width: "140px"},
		{field: "badQty", title:gfn_getMsg("col_badQuan"), width: "140px"},
		{field: "chkUserNm", title:gfn_getMsg("col_inspector"), width: "140px"},
		{field: "chkDate", format:"{0: yyyy-MM-dd}", title:gfn_getMsg("col_inspectDate"), width: "140px"},
		...
		{field: "badTargetCode", title:gfn_getMsg("col_badTargetCode"), width: "140px"},
		{field: "badDesc", title:gfn_getMsg("col_desc"), width: "140px"},
		
	];
	
	//7.
	lfo_prcesQual.selectBox = [
		{ text: gfn_getMsg("col_inspector"), value: "userInfo.user_nm" },
		{ text: gfn_getMsg("col_badId"), value: "bad.bad_id" }
	];
