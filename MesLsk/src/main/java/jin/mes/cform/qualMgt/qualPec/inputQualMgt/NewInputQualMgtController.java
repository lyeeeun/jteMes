...
public class NewInputQualMgtController extends BaseController {
	...
	@ResponseBody
	public String setInputQualDetailSave(@RequestBody NewInputQualMgtDto inputQualMgtDto) {
		return newInputQualMgtService.setInputQualDetailSave(inputQualMgtDto);
	}
