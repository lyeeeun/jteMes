...
*/			{ text: gfn_getMsg("col_desc"), value: "toolInfo.tool_desc" }			//설명
	...
	case "item"://부품정보
		...
		comPopObj.url = "/form/basMgt/operMgt/itemMgt/getItemList";
...
/*			{field: "itemMtrl",  template:"# var item = gfn_isNull(gfn_getCode(itemMtrl))== true ? '기초코드 없음' : gfn_getMsg('bc_'+ gfn_getCode(itemMtrl).cdVal , gfn_getCode(itemMtrl).cdNm) # #= item #",
	...
	case "material"://자재정보
		...
		comPopObj.url = "/form/basMgt/operMgt/mtrlInfo/getMtrlInfoList";
		comPopObj.prmtNm = ["use"];
		comPopObj.prmtVal = [true];
		comPopObj.model = {
			id: "mtrlId",
...
*/			{field: "mtrlStd03", format: "{0:n}", title:gfn_getMsg("col_weight"), width: "110px"},				//무게
			...
			{field: "mtrlStrStd01", title:"자재규격", width: "240px"},
	 		/*{field: "itemStdStr02", title : "예비2(Str)", width: "100px"},										//예비2(Str)
	 		{field: "itemStdStr03", title : "예비3(Str)", width: "100px"},										//예비3(Str)
	 		{field: "itemStdStr04", title : "예비4(Str)", width: "100px"},										//예비4(Str)
	 		{field: "itemStdStr05", title : "예비5(Str)", width: "100px"},										//예비5(Str) */
...
*/			{field: "mtrlStd03", format: "{0:n}", title:gfn_getMsg("col_weight"), width: 90},								//무게
	...
	case "lotInfo"://Lot 정보
		...
		comPopObj.prmtNm = [];
		comPopObj.prmtVal = [];
		comPopObj.url = "/form/orderMgt/orderDetailMgt/getLotList";
		comPopObj.model = {
			id: "lotSeq",
			fields: {
				lotSeq : { type: "int" },
...
*/			{field: "itemNm", title:gfn_getMsg("col_itemNm"), width: "220px;"},				//부품명
	...
	case "orderInfo": //수주 정보
		...
		comPopObj.prmtNm = [];
		comPopObj.prmtVal = [];
		comPopObj.url = "/form/orderMgt/orderDetailMgt/getOrderList";
		comPopObj.model = {
				id: "orderId",
				fields: {
					orderId: { type: "string" },
	...
	case "shipComp": //출하 업체(배송지) 정보
		...
		comPopObj.prmtNm = [];
		comPopObj.prmtVal = [];
		comPopObj.url = "/form/ship/shipPlanMgt/getShipCompList";
		comPopObj.model = {
				fields: {
					compId: { type: "string" },
					compNm: { type: "string" },
