...
@NoArgsConstructor
public class KwangjinItemRecevingMgtDto extends BaseVo{/**
	 * 
	 */
	private static final long serialVersionUID = -7260027713579229002L;

	public KwangjinItemRecevingMgtDto(String itemId, String itemMgtId, String itemMgtType, String itemMfgDate, int itemStock, int itemPackageStock,String description) {
		this.itemId = itemId;
	...
	public KwangjinItemRecevingMgtDto(String itemId, String itemMgtId, int itemQtyTotal, String itemQtyTarget, String itemQtyTargetCode, String itemQtyDate, String itemQtyUser) {
		this.itemId = itemId;
		this.itemMgtId = itemMgtId;
