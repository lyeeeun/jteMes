...
@NoArgsConstructor
public class KwangjinItemShipHisDto extends BaseVo{/**
	 * 
	 */
	private static final long serialVersionUID = -6603586253138827269L;
	
	public KwangjinItemShipHisDto(String itemId, String itemMgtId, int itemQtyTotal, String itemQtyTarget, String itemQtyTargetCode, String itemQtyDate, String itemQtyUser) {
		this.itemId = itemId;
