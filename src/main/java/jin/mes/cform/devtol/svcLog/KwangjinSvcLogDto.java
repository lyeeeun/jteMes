...
@NoArgsConstructor
public class KwangjinSvcLogDto  extends BaseVo {
	/**
	 * 
	 */
	...
	//생성자
	public KwangjinSvcLogDto(double svcLogTime, String svcLogPart, String svcLogMethod, String svcLogPath, String svcLogPrmt 
