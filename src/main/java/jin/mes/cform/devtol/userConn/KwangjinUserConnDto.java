...
@NoArgsConstructor
public class KwangjinUserConnDto  extends BaseVo {/**
	 * 
	 */
	private static final long serialVersionUID = -3114219623756912236L;
	
	//생성자
	public KwangjinUserConnDto(String connId, String userId, String connStdt, String connEddt, String connTime, String connIp, String connDevice) {
		this.connId = connId;
		this.userId = userId;
