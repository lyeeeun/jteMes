...
this.lfn_jteSgGrd_setGrd = function(){
	...
	lfo_common.customTitle = {
		html :	'<span style="margin : 0 14px 0 5px; float:left;">수주상태 : '+
				'<input name="orderState" id="orderState" value="ord_prcd01" readonly></span>'
...
this.lfn_jtePopGrd_setGrd = function(childItems){
	...
	lfo_popGrd.customTitle = {
		html :	'<span style="margin : 0 14px 0 5px; float: left !important;">LoT상태 : '+
				'<input name="lotState" id="lotState"></span>'
