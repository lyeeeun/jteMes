...
public class NewMtrlInfoController extends BaseController {
	...
	@ResponseBody
	public String setMtrlInfoSave(@RequestBody NewMtrlInfoDto mtrlInfoDto) {
		return newMtrlInfoService.setMtrlInfoSave(mtrlInfoDto);
	}
	...
	public String setMtrlRtlCompSave(@RequestBody NewCompMgtDto compDto) {
		return newMtrlInfoService.setMtrlRtlCompSave(compDto);
	}
