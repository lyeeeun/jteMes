...
public class NewFacilMgtController extends BaseController {
	...
	//설비상세 조회
		...
		public ModelMap getEqmtMgtList(ModelMap model, @ModelAttribute("eqmtMgtDto") NewFacilMgtDto eqmtMgtDto) {
			...
			try {
				setModelWithkendoList(model, newEqmtMgtService.getEqmtMgtList(eqmtMgtDto,pageRequestVo));
			}catch(Exception ex) {
		...
		public ModelMap getEqmtMgtListAll(ModelMap model, @ModelAttribute("eqmtMgtDto") NewFacilMgtDto eqmtMgtDto) {
			try {
				model.addAttribute("result", newEqmtMgtService.getEqmtMgtListAll(eqmtMgtDto));
			}catch(Exception ex) {
		...
		@ResponseBody
		public String setEqmtMgtSave(@RequestBody NewFacilMgtDto eqmtMgtDto) {
			return newEqmtMgtService.setEqmtMgtSave(eqmtMgtDto);
		}
