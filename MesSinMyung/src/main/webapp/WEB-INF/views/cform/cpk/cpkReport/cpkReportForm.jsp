...
this.lfn_tabBind = function(){
	tabData = [{
		text: "일간",
		content: "<div id='jteMasterGridDay' class='jteGrid' style='width:100%;'></div>"
	},{
		text: "월간",
		content: "<div id='jteMasterGridMonth' class='jteGrid' style='width:100%;'></div>"
	},{
		text: "연간",
		content: "<div id='jteMasterGridYear' class='jteGrid' style='width:100%;'></div>"
	}];
...
this.lfn_masterGridBind = function(gridId, datePickerId){
	...
	$("#" + gridId).kendoGrid({
			dataSource: {
				transport: {
					read: {
						url : "/cform/cpk/cpkReport/getCpkReportList",
						dataType : "json"
					},
