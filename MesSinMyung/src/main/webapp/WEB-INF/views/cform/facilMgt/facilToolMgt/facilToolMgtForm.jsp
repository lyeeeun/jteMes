...
<table id="grid-content"  style="width:100%;">
	<tr class="facilToolMgtForm">
		<td class="left-content-box">  <!-- style="display:inline-block; width:29%; height:100%; box-shadow: 0px 0px 4px 2px rgba(0, 0, 0, 0.13);  background:#f8f8f8;" -->
			<div id="jteMasterTree" class="jteMasterTree" style="height:100%;"></div>
		...
		<td class="right-content-box">
			<div id="jteSubGrid"></div>  <!-- style="display:inline-block; width:70%; height:100%;" -->
		</td>
	</tr>
</table>
...
this.lfn_jteToolPos_popOpen = function(mode,selectedItem){
	var options = {
		modal:true, 
		width: "650px", 
		height: "330px", //200507 그리드 더블 클릭→설비 장착 공구 팝업의 추가 버튼 클릭 시의'장착 가능 공구 조회' 팝업 크기 변경 460->515px_LYM 200519 JJW 330px
		id : lfo_popGrd.popId, 
