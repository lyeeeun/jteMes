...
<%-- 					<td>
				...
				<!-- 첨부파일 -->
					...
					<td colspan="5">
						<input name="attachFile" id="attachFiles" type="file" aria-label="files" format="file" code="routingId" />
...
this.lfn_jtePop_open = function(mode, selectedItem){
	var options = {
		...
		height: "400px", /** 200428 더블클릭 시 팝업창 height 변경 310->420_LYM 200506 JJW 높이 변경 310 -> 390 **/
		id : lfo_common.popId, 
