...
export declare class TabsComponent {
    ...
    selectedHis: any[];
    readonly containerCls: "f-column" | "f-row";
    readonly headerCls: "tabs-header-bottom f-order2" | "tabs-header-left f-column" | "tabs-header-right f-column f-order2";
    readonly bodyCls: "tabs-panels-top" | "tabs-panels-right" | "tabs-panels-left";
    readonly tabsStyle: {
        left: string;
    };
