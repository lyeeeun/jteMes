...
this.lfn_moveGraphView = function() {
	...
	goMenuToBody({menuId: "cpkExcel", svcUrl: "/form/cpk/cpkExcel", msgId: "mn_cpkExcel", msgView: "CPK - EXCEL", menuCd: "M", msgIdPath: "CPK - EXCEL", msgViewPath: "CPK - EXCEL", duplYn: "Y"}, {itemCd: $('#hidSelItemCd').val(), opNo: $('#hidSelOpNo').val()});
}
//Master Grid Refresh
