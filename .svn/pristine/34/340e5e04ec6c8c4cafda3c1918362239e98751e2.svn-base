...
<div style="width:100%;" class="cpkOverviewForm">
	<div class="cpkOverviewForm search-btn-area" style="width:100%; background:#f0f5ff; padding:15px 0 15px 0; margin:10px 0 5px 0;">
		<input type="text" id="cpkDept" class="cpkOverviewForm" name="cpkDept" style="margin-left: 10px;"/>
	...
	<div id="grid-content" class="cpkOverviewForm cpkOverviewForm-gird"> <!-- style="width:100%;" -->
		<div id="tabStrip" class="cpkOverviewForm"></div>
	</div>
</div>
...
this.lfn_setMachine = function() {
	...
	$.ajax({
		async:false,
		url: "/form/cpk/cpkVaneMonitor/getVaneMonitorList",
		type: "POST",
		data: { shiftCd: shiftTime, deptCd: $("#cpkDept").val()},
		datatype: "json",
...
this.lfn_graphDisplay = function(index, offsetMaster) {
	...
	$.ajax({
		async:false,
		url : "/form/cpk/cpkExcel/getCpkAggregation",
		type: "POST",
		data: { itemCd: offsetMaster.itemCd, opNo: offsetMaster.opNo, dimNo: offsetMaster.dimNo },
		datatype: "json",
		success: function(data){
	...
	$("#chart"+ index).kendoChart({
		...
		plotAreaClick: function(e) {
			goMenuToBody({menuId: "cpkOverviewDetail", svcUrl: "/form/cpk/cpkOverviewDetail", msgId: "mn_cpkOverviewDetail", msgView: "CPK Overview Detail", menuCd: "M", msgIdPath: "CPK Overview Detail", msgViewPath: "CPK Overview Detail", duplYn: "Y"}, 
