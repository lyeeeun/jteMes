...
@NoArgsConstructor
@AllArgsConstructor
public class ZinixWrkinTeamMgtDto extends BaseVo{/**
	 * 
	 */
	private static final long serialVersionUID = 4012687141552534795L;
	
	//일괄등록 - 생산지시용
	public ZinixWrkinTeamMgtDto(String prodAsmId, String prodAsmNm, String prodAsmDate, String prodAsmQty, String prodAsmDesc, String prodAsmUser, String prodAsmEmj, 
	...
	//일괄등록 - 작업지시용
	public ZinixWrkinTeamMgtDto(String prodAsmId, String prodPlanId, String lotId, String prodWorkId, String routingId, String eqmtMgtId, String prodWorkUser, String prodWorkQty, String prodWorkDesc) {
		this.prodAsmId = prodAsmId;
		this.prodPlanId = prodPlanId;
		this.lotId = lotId;
