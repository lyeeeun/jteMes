...
@NoArgsConstructor
public class MtrlHistoryDto extends BaseVo{/**
	 * 
	 */
	...
	public MtrlHistoryDto(String mtrlId, String mtrlQtyTarget, String mtrlQtyTargetCode, int mtrlQtyTotal, String mtrlQtyDate, String mtrlQtyUser,String mtrlMgtId, String lotId) {
		this.mtrlId = mtrlId;
