		...
		<form id="jtePopForm_form" class="mtrlInfoForm">
			...
			<colgroup>
				...
				<!-- 자재명 -->
					...
					<td><input type="text" id="mtrlNm" class="left-input" name="mtrlNm" format="text"/></td>
				<!-- 자재구분 -->
...
<%-- 					<td>
				...
				<!-- 본당기장 -->
					<td><i class="fas fa-caret-right"></i><spring:message code = "col_mainHall"></spring:message> : </td>
					<td><input type="text" id="mtrlStd02" class="right-input" name="mtrlStd02" format="numeric" /></td>
...
this.lfn_jteSgGrd_setGrd = function(){
	...
	*/
	...
	lfo_common.columns = [
		...
		{field: "mtrlId", title:gfn_getMsg("col_mtrlCd"), width: "130px"},											//자재코드
		...
		//{field: "mtrlUseday", format: "{0:n0}", title:시효기간, width: 100},
	...
	lfo_common.selectBox = [ 
		...
		/* { text: gfn_getMsg("col_mtrlType"), value: "mtrlInfo.mtrl_type" },			//자재유형 */
	];
	//8.
