...
<%-- 			<tr>
				...
				<!-- 부품명 -->
					...
					<td colspan="4">
						<input type="text" id="itemNm" class="center-input" name="itemNm" format="text" readonly/>
					</td>
<%--				<td> 부품 총 재고량: </td>
					<td>
...
<%-- 				<tr class="pop_detail_info">
				...
				<!-- 재질 -->
					<td class="td-right-title"><i class="fas fa-caret-right left-caret"></i><spring:message code = "col_qomtrl"></spring:message> : </td>
					<td>
						<input type="text" id="itemMtrl" class="right-input" name="itemMtrl" format="selBox" msg="comn_qomtrl" readonly />
					</td>
				</tr>
 				<tr class="pop_detail_info">
				<!-- 단위 -->
					...
					<td colspan="2">
						<input type="text" id="itemUnit" class="left-input" name="itemUnit" format="selBox" msg="comn_unit" readonly />
					</td>
				<!-- 무게 -->
					<td class="td-right-title"><i class="fas fa-caret-right left-caret"></i><spring:message code = "col_weight"></spring:message> : </td>
					<td>
						<input type="text" id="itemStd04" class="right-input" name="itemStd04" format="numeric" readonly />
					</td>
				</tr>
...
this.lfn_jteSgGrd_setGrd = function(){
	...
	*/
	...
	lfo_common.customTitle = {
		html :	'<div style="margin : 5px 0 5px 0;">반납여부 : '+
				'<input type="radio" name="delChk" id="delFalse" class="k-radio" checked="checked" value=false>' +
			 	'<label for="delFalse">사용 가능</label>'+
				'<input type="radio" name="delChk" id="delTrue" class="k-radio"  value=true>'+
				'<label for="delTrue">사용 완료</label>'+
	...
	lfo_common.columns = [
		...
		{field: "description", title:gfn_getMsg("col_desc"), width: "330px"},
...
this.lfn_jtePop_open = function(mode, selectedItem){
	var options = {
		...
		height: "600px", //20.05.07 첫번째 팝업 높이 JJW LYM 기본 값 600px
		id:lfo_common.popId, 
