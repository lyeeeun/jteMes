...
<%-- 					<td>
				...
				<!-- 위치명 -->
					...
					<td colspan="2">
						<input id="placeId" name="placeId" format = "selBox" custom="true" keyGbn="placeId" keyText="placeNm" func="lfn_placeParent_get()" />
					</td>
				</tr>
				<tr>
				<!-- 첨부파일 -->
...
this.lfn_jtePop_open = function(mode, selectedItem){
	var options = {
		modal:true, 
		width: "800px", //200506 JJW 팝업 너비 변경 600-> 660 /* 201012 JJW 660-> 800 */
		height: "430px", /** 200428 더블클릭 시 팝업창 height 변경 310->420_LYM 200506 JJW 높이 변경 310 -> 390 200807 youmi 400->427 200911 youmi 427->467 201016 youmi 467->430**/
		id : lfo_common.popId, 
...
this.lfn_placeParent_get = function(){
	return gfn_ajaxCallByList("place",{placeStrStd01 : "workLine"});
}
