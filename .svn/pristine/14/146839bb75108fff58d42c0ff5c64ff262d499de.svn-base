...
<div id="grid-content" class="grid-content">
	<table class="bomMgtForm jteBomGrid">
		<colspan>
		...
		<tr>
			...
			<td class="right-content-box"><button id="bomAddBtn" class="k-button k-primary bomAddBtn" type='button' id='editBtn' onclick="lfn_jtePop_open('NEW', '')">
			<!-- 신규생성 -->
			<spring:message code = "btn_newCreat"></spring:message></button><div id="bomTree"></div></td>
		</tr>
	</table>	
</div>
...
function visualTemplate(options) {
	...
	g.append(new dataviz.diagram.TextBlock({
		...
		x: 10,
		y: 20,
		fontSize: 16, /*14_LYM*/ /* 200413 Tree 제목 폰트 크기 수정_LYM */
		fontStyle: "bold",
