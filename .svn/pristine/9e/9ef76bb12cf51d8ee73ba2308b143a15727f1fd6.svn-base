...
public class DataSourceConfig {
	...
	private final static String MYBATIS_MAPPER_LOCATION_PATTERN_LIST = "classpath:/mapper/**/*Mapper.xml, " //JteComCore resource
			+ "classpath:/cmapper/**/*Mapper.xml"; //Project resource 
