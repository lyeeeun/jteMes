...
<div style="width:100%;">
	<div class="eqmtOperationPlanForm search-btn-area" style="width:100%; background:#f0f5ff; padding:15px 10px 15px 10px; margin:10px 0 5px 0;">
		<input type="text" class="k-textbox" id="lotId" readonly/>
	...
	<div class="eqmtOperationPlanForm k-content">
...
this.lfn_setScheduler = function() {
	...
	$.ajax({
		async:false,
		url : "/cform/mfgMgt/analsMgt/selectRoutingSheet",
		type: "POST",
