...
<div style="display:none;">
	<div id="routingSheetPop" class="routingSheetPop">
		...
		<div id="routingSheetPop_grid" class="routingSheetPop_grid" style="height:493px;"></div> <!-- 201120 YUMI_height 430->493 -->
	</div>
</div>
...
<div style="display:none;">
	<div id="mtrlUseTotalPop" class="mtrlUseTotalPop">
		...
		<div id="mtrlUseTotal_grid" class="productWorkAdminForm mtrlUseTotal-single-grid" style="width: 100%; height: 253px;"></div> <!-- 201120 YUMI_height 180->253 -->
	</div>
</div>
...
<div style="display:none;">
	<div id="mtrlUseDetailPop" class="wrkinWrkerMgtForm mtrlUseDetailPop">
		<div id="mtrlUseDetail_grid" class="productWorkAdminForm mtrlUseDetailPop-top-grid" style="width:100%; height:340px; min-height:300px;"></div> <!-- 201120 YUMI_height 300->340 -->
	</div>
</div>
...
this.lfn_jteDbGrid_gridSet = function(rows){
	...
	lfo_workAsgn.crud  = {
		...
		update : {url:"/setProdWorkAsgnSave", auth : "", openFunc : "", callback : lfn_asgnCreatePop_save}
...
this.lfn_mtrlUseSavePop_open = function(mode,target){
	var options = {
		...
		height: "242px", // 200515 JJW 250-> 300 -> 242
