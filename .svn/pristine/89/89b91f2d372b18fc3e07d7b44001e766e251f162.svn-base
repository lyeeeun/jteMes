...
<div style="width:100%;">
<!-- 	최상단 검색영역 -->
	<div style="width:100%; background:#E2ECFF; padding:15px 0 15px 15px; margin:10px 0 10px 0;">
		<!-- 월/일 체크박스 -->
		<input type="radio" name="dateType" id="monthChk" class="k-radio" checked="checked" value="month">
		<label for="monthChk" style="vertical-align:middle;"><spring:message code = "html_month"/></label>			<!-- 월 -->
		<input type="radio" name="dateType" id="dayChk" class="k-radio"  value="day">
		<label for="dayChk" style="vertical-align:middle;"><spring:message code = "html_day"/></label>								<!-- 일 -->
		<!-- 년/월 셀렉트 박스 -->
		<input id="jteYearSelBox" style="width:80px; margin-left:15px;"/>
		<input id="jteMonthSelBox" style="width:80px;"/>
		
		<!-- 진행중/종료 체크박스 -->
		<input type="radio" name="lotType" id="prosChk" class="k-radio" checked="checked" value="ord_sta01">
		<label for="prosChk" style="vertical-align:middle;"><spring:message code = "html_proceed"/></label>			<!-- 진행중 -->
		<input type="radio" name="lotType" id="endChk" class="k-radio" value="ord_sta02">
		<label for="endChk" style="vertical-align:middle;"><spring:message code = "html_end"/></label>								<!-- 종료 -->
	</div>
	<!-- 년/월 그리드 -->
			...
			<form id="jtePopForm_tab" class="mfgplanForm">
				<div style="width:100%; background:#E2ECFF; padding:15px 0 15px 0; margin:10px 0 10px 0;">
					<span class="bulkTypeArea">
						<!-- 등록/삭제 라디오박스 -->
						<input type="radio" name="bulkType" id="bulkInsert" class="k-radio" checked="checked" value="ins">
						<label for="bulkInsert" style="vertical-align:middle; margin-left:15px;">등록</label>
						<input type="radio" name="bulkType" id="bulkDelete" class="k-radio"  value="del">
						<label for="bulkDelete" style="vertical-align:middle;">삭제</label>
					</span>
					<span class="bulkTargetArea" style="float:right;">
						...
						<label for="bulkPlan" style="vertical-align:middle; margin-left:15px;">생산계획</label>
						...
						<label for="bulkAsgn" style="vertical-align:middle;">생산지시</label>
						...
						<label for="bulkWork" style="vertical-align:middle;">작업지시</label>
				...
				<table style="width:100%;">
					...
					<tr id="bulkPeriodChkArea">
						<td colspan="2">
							...
							<label for="bulkPeriod" style="vertical-align:middle; margin-left:15px;">기간 직접 지정</label>
