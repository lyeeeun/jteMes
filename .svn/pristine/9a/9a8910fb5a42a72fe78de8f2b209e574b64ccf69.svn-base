...
this.lfn_jteSgGrd_setGrd = function(){
	...
	*/
	...
	//3.
	lfo_common.ctrlUrl = "/form/orderMgt/claimMgt";
...
*/
	...
	//3.
	lfo_popGrd.ctrlUrl = "/form/orderMgt/claimMgt";
...
this.lfn_claimReorderPop = function(target){
	...
	lfo_claimReorder = {
		...
		ctrlUrl:"/form/orderMgt/claimMgt",
		crud:{ 
...
this.lfn_claimRegistryPop_setGrd = function(selectedItem){
	...
	//3.
	lfo_claimPopGrd.ctrlUrl = "/form/orderMgt/claimMgt";
