...
public class NewPerformEquipmentController extends BaseController {
	...
	public ModelMap getPerfromEquipInfo(@ModelAttribute("performEquipmentDto") NewPerformEquipmentDto performEquipmentDto, ModelMap model) {
		...
		setModelWithkendoList(model, newPerformEquipmentService.getPerfromEquipInfo(performEquipmentDto, pageRequestVo));

		return model;
	}
	
	@RequestMapping("/selectPlaceAll")
	public ModelMap getPerformOrderChart(@ModelAttribute("rlehoMgtDto") NewRlehoMgtDto rlehoMgtDto, ModelMap model) {
