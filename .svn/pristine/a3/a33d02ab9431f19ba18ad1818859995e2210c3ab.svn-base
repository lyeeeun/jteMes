...
@NoArgsConstructor
public class ZinixMtrltoolMgtDto extends BaseVo{/**
	 * 
	 */
	private static final long serialVersionUID = -35429912271129479L;

	//사용이력
	public ZinixMtrltoolMgtDto(String prodWorkId,String toolId, String toolMgtId, String eqmtMgtId, String eqipPosition, String lotId, int toolUseQty, String toolUseStart, String toolUseEnd, String toolUseDesc) {
