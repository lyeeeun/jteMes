...
<div style="display:none;">
	<div id="jteWorkEndPop">
		...
		<form id="jteWorkEndPop_form" class="productWorkForm wrkinWrkerMgtForm jteWorkEndPop_form">	
			<table class="jteWorkEndPop_table jteWorkEndPop_table_left"> <!-- 200513 LYM 안정적인 배치를 위해 좌측 우측 하단 세 테이블로 나눔 -->
				...
				<tr>
					...
					<td>
						<input class="center-input" name="prodWorkGood" format="currency"/>
					</td>
				</tr>				
				<tr>
					<!-- 작업종료 -->
...
this.lfn_workEndPop_Open = function(rows){
	var options = {
		modal:true, 
		width: "500px", 
		height: "283px", // 200512 JJW 작업종료 팝업 높이 270 -> 600px // 201120 YUMI_270->283
		id : "jteWorkEndPop", 
