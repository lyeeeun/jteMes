...
<div style="display:none;">
	<div id="jtePopAddForm" class="jtePopAddForm">
		...
		<!-- 발주계획 -->
			...
			<table id="jtePopForm_master" class="jtePopForm_master BasicTable">
			<colgroup>
				<col style="width: 22%;">
				<col style="width: 28%;">
				<col style="width: 22%;">
				...
				<!-- 자재명 -->
					...
					<td>
						...
						<button class="k-button k-primary" type="button" onclick="gfn_openCustomPop('material',lfn_mtrlPop_callback);" >
				<!-- 조회 -->
				...
				<!-- 자재구분 -->
					...
					<td><input id="mtrlDiv" type="text" name="mtrlDiv" placeholder="<spring:message code = "pop_mtrlSrhAuto"/>" format="text" readonly/></td>
				</tr>
				<tr>
				<!-- 업체명 -->
				...
				<!-- 자재와 수량을 입력하면 기본적으로 자동계산됩니다. -->
					...
					<td colspan="2"><input id="mtrlOrderCost" name="mtrlOrderCost" format="currency"/></td>
				</tr>				
				<tr>
				<!-- 설명 -->
					<td><i class="fas fa-caret-right"></i><spring:message code = "col_desc"></spring:message> : </td>
					<td><input type="text" id="mtrlOrderDesc" name="mtrlOrderDesc" format="text"/></td>
				</tr>
...
this.lfn_jteSgGrd_setGrd = function(){
	...
	//3.
	lfo_common.ctrlUrl = "/form/mfgMgt/mfgplanMgt/mrplanMgt"
	...
	lfo_common.columns = [
		...
		{field: "lotQty", format: "{0:n0}", attributes : { style : "text-align : right;"}, title:gfn_getMsg("col_lotQty"), width: "120px;"},				//수주수량
...
this.lfn_jtePop_open = function(mode, target){
	...
	var options = {
			modal:true, 
			width: "1200px",
			height: "410px", /* 400 -> 392px_200827 youmi JJW 392-> 410 */
			id : lfo_common.popId, 
...
this.lfn_jtePopGrd_setGrd = function(){
	...
	//3.
	lfo_popGrd.ctrlUrl = "/form/mfgMgt/mfgplanMgt/mrplanMgt";
	...
	lfo_popGrd.columns = [
		...
		{field: "lotQty",format: "{0:n0}", attributes : { style : "text-align : right;"}, title:gfn_getMsg("col_lotQty"), width: "90px;"},				//주문량
		...
		{field: "mtrlNeed", format: "{0:n0}", attributes : { style : "text-align : right;"},title:gfn_getMsg("col_needQty"), width: "110px;"},				//필요량
		{field: "mtrlMgtCnt",format: "{0:n0}", attributes : { style : "text-align : right;"}, title:gfn_getMsg("col_mtrlStockQty"), width: "120px;"},		//자재 재고량
		{field: "mtrlOrderQty",format: "{0:n0}", attributes : { style : "text-align : right;"}, title:gfn_getMsg("col_mtrlOrderExpect"), width: "110px;"},							//입고 예정
		{field: "mtrlUseNeed",format: "{0:n0}", attributes : { style : "text-align : right;"}, title:gfn_getMsg("col_mtrlUseExpect"), width: "110px;"},							//사용예정
		{field: "mtrlCanUse", format: "{0:n0}", attributes : { style : "text-align : right;"},title: gfn_getMsg("col_mtrlCanUse"),width: "90px;"},									//가용량
		{field: "mtrlOdCnt",format: "{0:n0}", attributes : { style : "text-align : right;"}, title: gfn_getMsg("col_mtrlOdQty"), width:"90px"},									//발주량
