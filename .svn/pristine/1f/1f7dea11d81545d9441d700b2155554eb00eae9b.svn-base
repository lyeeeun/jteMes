...
this.lfn_eqmtMtncPop_open = function(mode, selectedItem){
	var options = {
		...
		//height 260px
		height: "327px", //설비현황 그리드 우측 정비이력 버튼 클릭 > 추가 클릭 시의 팝업 height 변경_LYM 230->327px
...
this.lfn_jteEqmtWork_setGrd = function(dataItem){
	...
	*/
	...
	//3.
	lfo_eqmtWorkGrd.ctrlUrl = "/cform/facilMgt/facilCorMgt";
...
this.lfn_eqmtWorkPop_set = function(){
	...
	$.ajax({
		async:false,
		url : "/cform/facilMgt/facilCorMgt/getEqmtOverall",
		type: "POST",
