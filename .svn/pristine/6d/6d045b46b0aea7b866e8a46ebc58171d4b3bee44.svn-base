...
@NoArgsConstructor
public class ZinixMtrlHistoryDto extends BaseVo{/**
	 * 
	 */
	...
	public ZinixMtrlHistoryDto(String mtrlId, String mtrlQtyTarget, String mtrlQtyTargetCode, int mtrlQtyTotal, String mtrlQtyDate, String mtrlQtyUser,String mtrlMgtId, String lotId) {
		this.mtrlId = mtrlId;
