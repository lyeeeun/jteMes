...
<div style="display:none;">
	<div id="jtePopToolAdd">
		...
		<!-- 정비내역 -->
			...
			<table style="width:100%;" id="jtePopToolAdd_master" class="BasicTable">
			<colgroup>
				<col style="width:22%;">
				<col style="width:26%;">
				<col style="width:26%;">
				...
				<!-- 공구정비코드 -->
					...
					<td colspan="3"><input type="text" id="toolMtncId" name="toolMtncId" placeholder="<spring:message code = "pop_autoInput"></spring:message>" readonly/></td> 
				</tr>
				<tr>
				<!-- 정비시작일 -->
				...
				<!-- 정비종료일 -->
					<td class="td-right-title"><i class="fas fa-caret-right"></i><spring:message code = "col_mtncEndDate"></spring:message>
...
this.lfn_jtePop_open = function(mode, selectedItem){
	var options = {
		modal:true, 
		width: "600px", 
		height: "465px", // 200511 JJW 오른쪽 그리드 - 추가버튼 팝업 높이 기본값 youmi 420->425px JJW 425 -> 465
		id:lfo_subGrd.popId, 
		//title:"추가팝업",
		resizable : true,
...
// 		destroy:{url:"/setEqmtMgtDelete", auth:"", callback:lfn_jteGrid_delete}
	...
	lfo_toolUseGrd.columns = [
		{field: "toolUseQty", format:"{0:n0}", attributes : { style : "text-align : right;"}, title:gfn_getMsg("col_toolUseQuan"), width: "120px"},							//공구사용량
