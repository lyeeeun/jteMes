...
public class ZinixItemMgtDto extends BaseVo{
	...
	private List<ZinixCompMgtDto> compList;
	// 관련 업체 리스트(Delete)
	private List<ZinixCompMgtDto> delCompList;
	...
	private List<ZinixItemCompMgtDto> childCompMgtList;
