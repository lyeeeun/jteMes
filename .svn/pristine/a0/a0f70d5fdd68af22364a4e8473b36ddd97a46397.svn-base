...
public class NewToolMgtController extends BaseController {
	...
	public ModelMap getToolInfoList(ModelMap model, @ModelAttribute("toolMgtDto") NewToolMgtDto toolMgtDto) {
		...
		try {
			setModelWithkendoList(model, newToolMgtService.getToolInfoList(toolMgtDto,pageRequestVo));
		}catch(Exception ex) {
	...
	@ResponseBody
	public String setToolInfoSave(@RequestBody NewToolMgtDto toolMgtDto) {
		return newToolMgtService.setToolInfoSave(toolMgtDto);
	}
	...
	@ResponseBody
	public String setMtrlRtlCompSave(@RequestBody NewCompMgtDto compDto) {
		return newToolMgtService.setToolRtlCompSave(compDto);
	}
	...
	public ModelMap getAllToolInfoList(ModelMap model, @ModelAttribute("toolMgtDto") NewToolMgtDto toolMgtDto) {
		try {
			model.addAttribute("result", newToolMgtService.getAllToolInfoList(toolMgtDto));
		}catch(Exception ex) {
