...
public class BaseSetMgtController extends BaseController {
	...
	public ModelMap setCode(@RequestBody BaseCodeMgtDto baseSetMgtDto, ModelMap model) {
	...
	public ModelMap addCode(@RequestBody BaseCodeMgtDto baseSetMgtDto, ModelMap model) {
