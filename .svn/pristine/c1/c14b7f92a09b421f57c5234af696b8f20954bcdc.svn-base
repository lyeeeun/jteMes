...
public class NewRlehoMgtController extends BaseController {
	...
	@RequestMapping("getPlaceListAll")
	public ResponseEntity<Object> getPlaceListAll(ModelMap model, @ModelAttribute("newPlaceDto") NewRlehoMgtDto newPlaceDto) {
		return new ResponseEntity<Object>(newPlaceService.getPlaceListAll(newPlaceDto), HttpStatus.OK);
	}
