...
public class ZinixWrkinTeamMgtController extends BaseController {

	@Autowired
	ZinixWrkinTeamMgtService asgnService;
	
	@RequestMapping("/getAsgnList")
	public ModelMap getAsgnList(ModelMap model, @ModelAttribute("asgnDto") ZinixWrkinTeamMgtDto asgnDto) {
	...
	public ModelMap getAsgnPop(ModelMap model, @ModelAttribute("asgnDto") ZinixWrkinTeamMgtDto asgnDto) {
		try {
	...
	@ResponseBody
	public String setAsgnSave(@RequestBody ZinixWrkinTeamMgtDto asgnDto) {
		return asgnService.setAsgnSave(asgnDto);
	}
	
	@RequestMapping("/setAsgnDelete")
	@ResponseBody
	public int setAsgnDelete(ModelMap model, @RequestBody List<ZinixWrkinTeamMgtDto> mtrlOrderList) {
