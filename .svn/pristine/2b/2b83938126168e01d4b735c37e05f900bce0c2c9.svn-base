...
//	++libTabs._nowTabCnt; 의미 없을듯.
	...
	if(menuInfo.menuId == "home"){
		var tabMenuCtrl = '<li id="'+tabId+'-li" menuId = "'+menuInfo.menuId+'" class="home_tab link" style="background: #00498c; border: none;"><span><a href="#'+tabId+'" class="txt" title="'+menuInfo.msgViewPath+'">'+
