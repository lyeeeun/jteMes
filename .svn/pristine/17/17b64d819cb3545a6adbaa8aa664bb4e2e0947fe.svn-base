...
public class MtrlOdplanMgtController extends BaseController {
	...
	@ResponseBody
	public String setMtrlOrderSave(@RequestBody MtrlOdplanMgtDto mtrlOrderDto) {
		return mtrlOrderService.setMtrlOrderSave(mtrlOrderDto);
	}
	
	@RequestMapping("/setMtrlOrderBatchSave")
	@ResponseBody
	public String setMtrlOrderBatchSave(@RequestBody List<MtrlOdplanMgtDto> mtrlOrderList) {
		return mtrlOrderService.setMtrlOrderBatchSave(mtrlOrderList);
	}
	
	@RequestMapping("/setMtrlOrderDelete")
	@ResponseBody
	public int setMtrlOrderDelete(ModelMap model, @RequestBody List<MtrlOdplanMgtDto> facilMgtList) {
