...
@Controller
@RequestMapping("/form/basMgt/userMgt/userInfo")
public class UserInfoController extends BaseController {
	...
	public ModelMap getUserList(ModelMap model, @ModelAttribute("userInfo") UserInfoDto userInfo) {
	...
	public ResponseEntity<Object> getUserRoleList(ModelMap model, @ModelAttribute("userAuthDto") UserAuthDto userAuthDto) {
...
//			final JPQLQuery<Account> query;
	...
	@ResponseBody
	public int setUserSave(ModelMap model, @RequestBody UserInfoDto userInfo) {
		int reutrnInt = 0;
		try {
