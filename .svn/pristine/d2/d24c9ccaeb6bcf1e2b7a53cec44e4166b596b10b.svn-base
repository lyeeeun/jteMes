	...
	$(document).ready(function(){
		...
		$("#toolbar").kendoToolBar({
			items: [
				...
				{ template: "<img src='resources/mes/img/Test_logo.png' style='margin-left: 20px; height:35px; margin:5px;'>" }, /* template: "<img src='resources/mes/img/sinmyeong_logo_png.png' style='margin-left: 20px; height:35px; margin:5px;'>" 여기서 로고 수정 */
