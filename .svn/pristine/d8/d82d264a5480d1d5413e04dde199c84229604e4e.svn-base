...
public class WrkinTeamMgtDto extends BaseVo{/**
	...
	//일괄등록 - 생산지시용
	public WrkinTeamMgtDto(String prodAsmId, String prodAsmNm, String prodAsmDate, int prodAsmQty, String prodAsmDesc, String prodAsmUser, String prodAsmEmj, 
	...
	//일괄등록 - 작업지시용
	public WrkinTeamMgtDto(String prodAsmId, String prodPlanId, String lotId, String prodWorkId, String routingId, String eqmtMgtId, String prodWorkUser, int prodWorkQty, String prodWorkDesc) {
		this.prodAsmId = prodAsmId;
		this.prodPlanId = prodPlanId;
		this.lotId = lotId;
