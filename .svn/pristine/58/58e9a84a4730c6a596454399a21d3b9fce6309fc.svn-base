...
this.lfn_jtePopGrd_setGrd = function(selectedItem){
	...
	//3.
	lfo_popGrd.ctrlUrl = "/form/ship/rlesMgt";
...
this.lfn_pkgWorkPop_open = function(){
	...
	lfo_popGrd.bundleDeleteList = new Array();
 	...
 	var options = {
		modal:true, 
		width: "800px",
		height: "468px",  //200507 출고 관리 그리드의 포장 작업 버튼 클릭 → 추가 버튼 클릭 시의 팝업창 height 변경_550->360px LYM 200511 JJW 550-> 410px 200810 youmi 430->468px
		id : "pkgWorkInfo", 
...
this.lfn_checkListPop_open = function(){
	var options = {
			...
			height: "405px", //200518 JJW 체크리스트 팝업 높이 550 -> 400 200810 youmi 400->405px
			id : "pop_checkList", 
...
this.lfn_bundlePop_open = function(){
 	var options = {
		modal:true, 
		width: "680px", //200518 JJW 너비 900-> 680
		height: "500px", //200518 JJW 출고 관리 그리드의 포장 작업 버튼 클릭 → 추가 버튼 클릭  → 불량 정보 등록 버튼 클릭 시의 팝업창 height 변경_550->480px 200810 youmi 480->500px  
		id : "pop_bundleInfo", 
...
this.lfn_bundlePopup = function() {
	...
	$.ajax({
		async:false,
		url : "/form/ship/rlesMgt/getRtlBundleList",
		type: "POST",
...
this.lfn_jteBundleGrd_setGrd = function(selectedItem){
	...
	//3.
	lfo_bundleGrd.ctrlUrl = "/form/ship/rlesMgt";
...
this.lfn_pkg_complete = function() {
	$.ajax({
		async:false,
		url : '/form/ship/rlesMgt/updatePkgPlanState',
		type: "POST",
