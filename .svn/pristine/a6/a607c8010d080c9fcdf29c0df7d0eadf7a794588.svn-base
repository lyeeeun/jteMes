package jin.mes.form.mfgMgt.mfgplanMgt.mfgplan.SinMyung;
...
import jin.mes.form.mfgMgt.mfgplanMgt.mfgplan.MfgplanServiceImpl;
...
@Primary
@Service
public class MfgplanServiceImpl_SinMyung extends MfgplanServiceImpl{
