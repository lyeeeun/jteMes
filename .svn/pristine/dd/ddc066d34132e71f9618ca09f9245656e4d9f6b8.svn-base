	...
	<div id="jtePopForm">
		<form id="jtePopForm_form" class="techDocMgtForm" >
			...
			<colgroup>
				...
				<tr>
					<!-- 기술문서 그룹 구분 -->
					<td><i class="fas fa-caret-right"></i><spring:message code = "col_division"/> : </td>
				...
				<tr>
				<!-- 기술문서 그룹 ID -->
					<td><i class="fas fa-caret-right"></i><spring:message code = "col_groupId"/> : </td>
					<td colspan="2">
				...
				<tr>
				<!-- 기술문서 그룹 명 -->
				<td><i class="fas fa-caret-right"></i><spring:message code = "col_groupName"/> :  </td>
					<td colspan="3">
	...
	<div id="techDocRegForm" class="techDocMgtForm">
		<form id="techDocRegForm_form" class="techDocRegForm techDocMgtForm" >
			<table style="width:100%;" id="techDocRegForm_master" class="techDocRegForm_master">
				...
				<tr>
					<!-- 기술문서 그룹 구분 -->
					<td><i class="fas fa-caret-right"></i><spring:message code = "col_documentType"/> : </td>
					<td colspan="3"><input id="documentCd" name="documentCd" format = "selBox" msg="techDocCd" class="center-input"/></td>
				</tr>
				<tr>
				<!-- 기술문서 그룹 ID -->
					<td><i class="fas fa-caret-right"></i><spring:message code = "col_documentNumber"/> : </td>
					<td>
				...
				<tr>
				<!-- 기술문서 그룹 명 -->
					<td><i class="fas  fa-caret-right"></i><spring:message code = "col_documentTitle"/> :  </td>
