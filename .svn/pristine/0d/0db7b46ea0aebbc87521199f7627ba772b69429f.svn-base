...
public class NewMtrltoolMgtController extends BaseController {
	...
	@RequestMapping("/selectToolMgtDupleKeyCount")
	@ResponseBody
	public int selectMidlotDupleKeyCount(@RequestBody NewMtrltoolMgtDto newToolMgtDto) {
		return newMtrltoolMgtService.selectToolMgtDupleKeyCount(newToolMgtDto);
	}
