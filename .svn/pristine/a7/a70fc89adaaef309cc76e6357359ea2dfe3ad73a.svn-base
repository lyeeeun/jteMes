...
this.lfn_jtePop_open = function(mode, selectedItem){
	var options = {
		modal:true, 
		width: "600px", 
		height: "420px", // 200511 JJW 오른쪽 그리드 - 추가버튼 팝업 높이 기본값 330px -> 420px _ LYM 330 -> 415
		id:lfo_subGrd.popId, 
		//title:"추가팝업",
		resizable : true,
