...
this.lfn_jteSgGrd_setGrd = function(){
	...
	//3.
	lfo_asgnPop.ctrlUrl = "/form/mfgMgt/productWork"
...
this.lfn_plcIncludeGrd_setGrd = function(){
	...
	//3.
	lfo_include.ctrlUrl = "/form/qualMgt/qualPec/finalQualMgt"
...
this.lfn_plcExcludeGrd_setGrd = function(){
	...
	//3.
	lfo_exclude.ctrlUrl = "/form/qualMgt/qualPec/finalQualMgt"
...
this.lfn_measure_gridSet = function(){
	...
	//3.
	lfo_measure.ctrlUrl = "/form/qualMgt/qualPec/finalQualMgt"
...
this.lfn_measurePop_gridSet = function(){
	...
	//3.
	lfo_measurePop.ctrlUrl = "/form/qualMgt/qualPec/finalQualMgt"
