...
<div id="grid-content" style="width:100%;">
	<div id="jteSingleGrid"></div>   <!-- style="display:inline-block; width:39%; height:100%;" -->
</div>
...
<div style="display:none;">
	<div id="jtePopForm" class="smplPectMgtForm itemBadListPop">
		<div class="smplPectMgtForm radio-btn-area">
			<input type="radio" name="badType" id="itemChk" class="k-radio" checked="checked" value="item">
			<label for="itemChk" style="vertical-align:middle; margin-left:15px; margin-right: 10px;"><spring:message code = "pop_item"></spring:message></label>
			<input type="radio" name="badType" id="mtrlChk" class="k-radio"  value="mtrl">
