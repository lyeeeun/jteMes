...
//			result.put("result", "MSG");
//			result.put("code", new Random().nextInt(5) + 1000);
//			result.put("title", "확인요망["+result.get("code")+"]");
//			result.put("msg", "안녕하세요. 메시지보내는 테스트입니다. 메시지를 확인해 주세요.");
//			result.put("detail", "안녕하세요.\n"
//					+ "1번 시스템에 문제가 발생했습니다.\n"
//					+ "시스템 로깅에 문제가 있는 메시지테스트 전달사항이며,\n"
//					+ "1번 시스템에 접속의 상세상태를 확인하시려면 알림메시지를 클릭하여 상세정보를 보실 수 있습니다.");
