...
public class NewRlesMgtDto extends BaseVo{
	...
	private List<NewRlesMgtDto> bundleInsertList;
	// 포장 리스트(Update)
	private List<NewRlesMgtDto> bundleUpdateList;
	// 포장 리스트(Delete)
	private List<NewRlesMgtDto> bundleDeleteList;
