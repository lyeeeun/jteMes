...
<div class="orderCompleteMgtForm search-btn-area">
	<label>프로젝트 : </label>
	...
	<button class="k-button k-primary" type="button" id="orderCompleteBtn" onclick= "lfn_orderStateComplete()" style="float:right; margin-right:20px">프로젝트 완료</button>
</div>
...
this.lfn_jteSgGrd_setGrd = function(){
	...
	*/
	...
	//3.
	lfo_common.ctrlUrl = "/cform/ship/orderCompleteMgt";
...
this.lfn_lotStateComplete = function(rows){
	...
	.done(function(){
		$.ajax({
			async:false,
			url : '/cform/ship/orderCompleteMgt/lotStateUpdate',
			type: "POST",
...
this.lfn_orderStateComplete = function(){
	...
	.done(function(){
		$.ajax({
			async:false,
			url : '/cform/ship/orderCompleteMgt/orderStateUpdate',
			type: "POST",
...
this.lfn_procShiftTable = function(rows){
	...
	$.ajax({
		async:false,
		url : '/cform/ship/orderCompleteMgt/selectProcShiftTable',
		type: "POST",
...
this.lfn_returnSurplusMtrl = function(rows){
	...
	$.ajax({
		async:false,
		url : '/cform/ship/orderCompleteMgt/selectReturnSurplusMtrl',
		type: "POST",
		data: {lotId: paramLotId},
		success: function(data){
			$.each(data.rows, function(index, item) {
