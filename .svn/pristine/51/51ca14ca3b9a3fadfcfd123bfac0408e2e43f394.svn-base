...
this.lfn_jteSgGrd_setGrd = function(){
	...
	*/
	...
	//6.
	lfo_common.columns = [
		{field: "incomingInspection", editable: function(){return false;}, title: gfn_getMsg("mn_inputQualMgt"), width:"95px",			//수령
			template : function(rows) {
				return '<button class="k-button k-primary" type="button" onclick = "gfn_inspectPop(\'EDT\', \'incommingInspect\', \'pop_incommingInspect\', \'' + rows.inspectId + '\') " style="width:60px;">'+ gfn_getMsg("mn_inputQualMgt")+'</button>';					//내역보기
			}
		},
		{field: "inspectId", title:gfn_getMsg("col_inspectCd"), width: "170px;"},													//포장작업코드
		{field: "targetId", title:gfn_getMsg("col_targetId"), width: "220px;"},															//부품명
