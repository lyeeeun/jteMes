...
<div style="display:none;">
	<div id="jtePopForm">
		<form id="jtePopForm_form" class="specProcMgtForm">
			...
			<table style="width:100%;" id="jtePopForm_master" class="specProcMgtForm BasicTable">
			<colgroup>
				<col style="width: 20%;">
				<col style="width: 30%;">
				<col style="width: 22%;">
				...
				<tr>
					...
					<td><input type="text" id="spcId" name="spcId" format="text" placeholder="<spring:message code = "pop_autoInput"></spring:message>" readonly /></td>
					<!-- 프로젝트명  -->
					<td class="td-right-title"><i class="fas fa-caret-right"></i>프로젝트 명 : </td>
					<td><input type="text" id="spcNm" name="spcNm" format="text" /></td>
				</tr>
				<tr>
					<!-- 품목  -->
					<td><i class="fas fa-caret-right"></i>품목 아이디 : </td>
					<td>
						<input type="text" id="spcItem" class="btn-input" name="spcItem" format="text" readonly/> 
						<input type="hidden" id="itemId" name="itemId"/>
						<button class="k-button k-primary" type="button" onclick="lfn_itemPop_Open(lfn_itemPop_callback)">
				<!-- 조회 -->
				...
				<!-- 시작일 -->
					...
					<td><input id="spcStartDt" name="spcStartDt" format="datepicker"/></td> 
				<!-- 종료일 -->
					<td class="td-right-title"><i class="fas fa-caret-right left-caret"></i>종료일 : </td>
					<td><input id="spcFinishDt" name="spcFinishDt" format="datepicker"/></td> 
				</tr>
				<tr>
					<!-- 상태  -->
					<td><i class="fas fa-caret-right"></i>상태: </td>
					<td><input id="spcStatus" name="spcStatus" format="selBox" msg="spc_status" /></td>
					<!-- 현상  -->
					<td class="td-right-title"><i class="fas fa-caret-right"></i>현상 : </td>
					<td><input type="text" id="spcPnmn" name="spcPnmn" format="text" /></td>
				</tr>

				<tr>
					<!-- 원인  -->
					<td><i class="fas fa-caret-right"></i>원인 : </td>
					<td><input type="text" id="spcCause" name="spcCause" format="text" /></td>
					<!-- 목표  -->
					<td class="td-right-title"><i class="fas fa-caret-right"></i>목표 : </td>
					<td><input type="text" id="spcGoal" name="spcGoal" format="text" /></td>
				</tr>

				<tr>
					<!-- 대책안  -->
					<td><i class="fas fa-caret-right"></i>대책안 : </td>
					<td colspan="3"><input type="text" id="spcMeasure" name="spcMeasure" format="text" /></td>
				</tr>
				<tr>
					<!-- 실행결과  -->
					<td><i class="fas fa-caret-right"></i>실행결과 : </td>
					<td colspan="3"><input type="text" id="spcResult" name="spcResult" format="text" /></td>
				</tr>
				<tr>
					<!-- 효과파악  -->
					<td><i class="fas fa-caret-right"></i>효과 파악 : </td>
					<td colspan="3"><input type="text" id="spcEffect" name="spcEffect" format="text" /></td>
				</tr>
				<tr>
					<!-- 표준화  -->
					<td><i class="fas fa-caret-right"></i>표준화 : </td>
					<td colspan="3"><input type="text" id="spcStandard" name="spcStandard" format="text" /></td>
				</tr>
				<tr>
					<!-- 담당자  -->
					<td><i class="fas fa-caret-right"></i>담당자 : </td>
					<td><input type="text" id="spcManager" name="spcManager" format="text" /></td>
					<!-- 알람  -->
					<td class="td-right-title"><i class="fas fa-caret-right"></i>알람 : </td>
					<td><input type="text" id="spcAlarm" class="btn-input" name="spcAlarm" format="text" />
					<button class="k-button k-primary" type="button" >전송</button></td>
				</tr>
				<tr>
					<!-- 관련자료  -->
			...
			<div class="specProcMgtForm final-btn-area" style="text-align:center;">
...
this.lfn_jtePop_open = function(mode, selectedItem){
	var options = {
		modal:true, 
		width: "705px", 
		height: "580px",  /** 200428 첫번째 팝업 높이 변경 565px->600px_LYM **/ /* 200824 JJW 650px -> 580px */
		id:lfo_common.popId, 
		resizable : true,
