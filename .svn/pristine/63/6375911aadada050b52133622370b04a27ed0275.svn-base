...
public class NewRlesMgtController extends BaseController {
	...
	public ModelMap getPerformTotalOrderChart(@ModelAttribute("rlesMgtDto") NewRlesMgtDto rlesMgtDto, ModelMap model) {
		model.addAttribute("rows", newRlesMgtService.getRtlBundleList(rlesMgtDto));
