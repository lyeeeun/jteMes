		...
		<!-- 수령정보 -->
			...
			<colgroup> <!-- 15 25 15 25 완료정보 조회 버튼 때문에 1행 추가-->
				...
				<!-- 수령자 -->
					...
					<td>
						<input id="mtrlOrderUserNm" class="left-input btn-input" name="mtrlOrderUserNm" format="text" readonly/>
				...
				<tr>
					...
					<td>
						<input id="mtrlChargeUserNm" class="center-input btn-input" name="mtrlChargeUserNm" format="text" readonly/>
						<input type="hidden" name="mtrlChargeUser" id="mtrlChargeUser"/>
					</td>
					<td>
						<button class="k-button k-primary search-btn" type="button"  onclick="lfn_userInfoPop_Open(lfn_userChargePop_callback)">조회</button>
					</td>
				</tr>
				<tr style="display:hidden;">
					<td>
