...
<div style="width:100%;" class="shopSchdMgtForm">
	<div class="shopSchdMgtForm search-btn-area" style="width:100%; background:#f0f5ff; padding:15px 0 15px 0; margin:10px 0 5px 0;">
	...
	<div id="grid-content" class="shopSchdMgtForm shopSchdMgtForm-gird"> <!-- style="width:100%;" -->
...
this.lfn_setGanttChart = function(){
   ...
   $.ajax({
      async:false,
      url : '/form/prcesMgt/gantChtMgt/getGanttChart',
      type: "POST",
