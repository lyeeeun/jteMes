...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	{
		web.ignoring().antMatchers("/favicon.ico", "/css/**", "/js/**", "/image/**", "/jquery-easyui/**", "/angularjs/**", "/jui/**", "/ng-easyui/**", "/error/**", "/sample/**", "/registration", "/loginProcess");
	}
...
//				.antMatchers("/css/**", "/js/**", "/image/**", "/jquery-easyui/**", "/ng-easyui/**", "/sample/**", "/registration").permitAll()
		...
		http.exceptionHandling().accessDeniedPage("/error/403"); // 권한이 없을경우 해당 url로 이동
