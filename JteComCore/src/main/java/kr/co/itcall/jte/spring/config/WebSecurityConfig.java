...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	@Resource
	private JteAuthenticationSuccessHandler jteAuthenticationSuccessHandler;
	
	@Resource
	private LogoutSuccessHandler jteLogoutSuccessHandler;
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.formLogin().loginPage("/login") // default
				...
				.successHandler(jteAuthenticationSuccessHandler) // 로그인 성공 핸들러
				.failureHandler(new JteAuthenticationFailureHandler()) // 로그인 실패 핸들러A
				.permitAll();

		http.logout().logoutUrl("/logout") // default
				.logoutSuccessUrl("/login")
				.logoutSuccessHandler(jteLogoutSuccessHandler)
