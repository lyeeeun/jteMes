...
//	@PreAuthorize(("hasAuthority('auth.basMgt.codeMgt.bas')"))
	...
	public ModelMap getItemPop(@ModelAttribute("ItemMgtDto") ItemMgtDto itemMgtDto, ModelMap model) {

		model.addAttribute("rows", itemMgtService.getItemPop(itemMgtDto));
	...
	@ResponseBody
	public String setItem(@RequestBody ItemMgtDto itemMgtDto) {
		return itemMgtService.setItem(itemMgtDto); 
	}
