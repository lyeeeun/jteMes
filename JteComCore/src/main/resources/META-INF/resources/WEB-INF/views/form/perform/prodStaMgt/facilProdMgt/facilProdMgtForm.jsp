...
<!-- 마스터 그리드 영역 -->
<div style="width:100%;">
	<div class="facilProdMgtForm search-btn-area" style="width:100%; background:#f0f5ff; padding:15px 0 15px 0; margin:10px 0 5px 0;">
	<input type="text" class="k-textbox" id="eqmtMgtId" readonly style="margin-left: 10px;"/>
	<button class="k-button k-primary page-search-btn" type="button" id="eqmtMgtSelBtn" onclick= "lfn_eqmtMgt();"><spring:message code = "btn_search"/></button>
	</div>
	<div id="grid-content" class="facilProdMgtForm facilProdMgtForm-gird"> <!-- style="width:100%;" -->
...
this.lfn_jteSgGrd_setGrd = function(){
	...
	lfo_common.ctrlUrl = "/form/perform/prodStaMgt/facilProdMgt"
	
	lfo_common.crud  = {
		read:{url:"/getEqmtProd", auth:"", prmt:{eqmtMgtId: $('#eqmtMgtId').val()}, search : false}
	};
