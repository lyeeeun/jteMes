		...
		<form id="jtePopForm_form" class="jtePopForm_form orderDetailMgtForm orderDetailMgtForm_jtePopForm_form">
			...
			<colgroup>
				...
				<!-- 수주명 -->
					...
					<td colspan="5"><input type="text" id="orderNm" class="center-input" name="orderNm" format="text" readonly/></td> 
				</tr>
				<tr>
				<!-- 수주일 -->
					<td><i class="fas fa-caret-right"></i><spring:message code="col_orderDate" /> : </td>
					<td colspan="2"><input id="orderStdt" class="left-input" name="orderStdt" format="datepicker" readonly/></td> 
				<!-- 납기일 -->
					<td class="td-right-title"><i class="fas fa-caret-right left-caret"></i><spring:message code="col_deliveryDate" /> : </td>
					<td colspan="2"><input id="orderEddt" class="right-input" name="orderEddt" format="datepicker" readonly/></td> 
				</tr>
				<tr>
				<!-- 비용 -->
					<td><i class="fas fa-caret-right"></i><spring:message code="col_cost" /> : </td>
					<td colspan="2"><input id="orderCost" class="left-input" name="orderCost"  format="currency" readonly/></td> 
				<!-- 관리자 -->
				...
				<!-- 설명 -->
					...
					<td colspan="5"><textarea id="description" class="center-input" name="description" class="k-textbox" rows="3" readonly></textarea></td>  
				</tr>
		...
		<form id="jtePopAddForm_form" class="jtePopAddForm_form orderDetailMgtForm orderDetailMgtForm_jtePopAddForm_form">
			...
			<colgroup>  <!-- 200507 원래는 col 4개에 각각의 width가 15 35 15 35였으나 col 6개로 변경_LYM -->
				...
				<tr>
					...
					<td colspan="5">
						<input type="text" id="lotNm" class="left-input" name="lotNm" readonly/>	
					</td>
				</tr>
				<tr>
					<td>
					...
					<td colspan="2">
						<input id="lotQty" class="left-input" name="lotQty" format="currency" readonly/>
					</td>
...
<!-- 전주원 주임 작업 CSS -->
<link href='/resources/mes/css/contents/orderMgt/orderSheet/orderDetailMgt/orderStatusForm_JJW.css' rel="stylesheet">
...
this.lfn_jteSgGrd_setGrd = function(){
	...
	*/
	...
	//3.
	lfo_common.ctrlUrl = "/form/orderMgt/orderSheet/orderDetailMgt";
	...
	lfo_common.columns = [
		...
		{field: "compNm", title:gfn_getMsg("col_compNm"), width: "110px"},												//업체명
 		{field: "orderState",template:"# var item = gfn_isNull(orderState)== true ? '' : gfn_getMsg('bc_'+ gfn_getCode(orderState).cdId , gfn_getCode(orderState).cdNm) # #= item #",
				title:gfn_getMsg("col_proceedStatus"), width: "110px"}														//수주상태
	];
