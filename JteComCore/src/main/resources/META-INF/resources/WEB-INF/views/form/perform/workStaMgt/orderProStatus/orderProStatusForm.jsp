...
<div id="grid-content" class="orderProStatusForm">
	<div class="orderProStatusForm search-btn-area">
	...
	<table class="orderProStatusForm-table">
		<colgroup>
...
this.lfn_orderChartDisplay = function() {
	...
	$.ajax({
		async:false,
		url : '/form/perform/workStaMgt/orderProStatus/getTotalOrderChart',
		type: "POST",
...
this.lfn_chartDisplay = function() {
	$.ajax({
		async:false,
		url : '/form/perform/workStaMgt/orderProStatus/getOrderChart',
		type: "POST",
		data: {orderId: $('#orderId').val()},
		success: function(data){
