...
this.lfn_masterGridBind = function(){
	...
	//그리드 columns
	lfo_common.msgLangColumns = [{selectable : true, width:"30px"},{ field: "msgId", title: gfn_getMsg("col_msgId"), width: "100px" }];																								//메시지아이디
	//grid Search Field
	...
	gfn_getCode("msgLangCode").forEach(function(item,index){
		...
		//grid columns
		lfo_common.msgLangColumns.push({ field: langType+"CdNm", template:"# var item =  gfn_isNull("+langType+"CdNm) == true ? '미등록' : "+langType+"CdNm # #= item #", title: gfn_getMsg("col_lang"), width: "50px" });			//코드명(언어)
