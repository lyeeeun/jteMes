...
<div style="width:100%;">
	<div class="mqsToolMgtForm search-btn-area" style="width:100%; background:#f0f5ff; padding:15px 0 15px 0; margin:10px 0 5px 0;">
...
<div style="display:none;">
	<div id="toolRegForm" class="toolRegForm">
		<form id="toolRegForm_form" class="toolRegForm mqsToolMgtForm mqsToolMgtForm_toolRegForm_form" >
			<table id="toolRegForm_master" class="toolRegForm_master">  <!-- style="width:100%;" -->
				<colgroup>
				...
				<!-- 기술문서 그룹 구분 -->
					...
					<td colspan="2">
						<input id="toolNo" name="toolNo" class="left-input"/>
						<input type="hidden" name="action" id="mqsToolInfoAction"/>
					</td>
					<td class="td-right-title"><i class="fas fa-caret-right left-caret"></i>TOOL 물품번호 : </td>
					<td><input id="toolId" name="toolId" class="right-input btn-input" readonly/></td>
					<td><button class="k-button k-primary popsc-btn search-btn" type="button" onclick = "lfn_toolInfo('tool')">조회</button></td>
				</tr>
				<tr>
					<td><i class="fas fa-caret-right"></i>TOOL 명칭 : </td>
					<td colspan="2"><input id="toolNm" name="toolNm" class="left-input" readonly/></td>
					<td class="td-right-title"><i class="fas fa-caret-right left-caret"></i>TOOL 사양 : </td>
					<td colspan="2"><input id="toolDc" name="toolDc" class="right-input" readonly/></td>
				</tr>
				<tr>
					<td><i class="fas fa-caret-right"></i>특기사항 : </td>
					<td colspan="2"><input id="specialDc" name="specialDc" class="left-input"/></td>
					<!-- 기술문서 그룹 구분 -->
					<td class="td-right-title"><i class="fas fa-caret-right left-caret"></i>HOLDER 물품번호 : </td>
					<td><input id="holderId" name="holderId" class="right-input btn-input" readonly/></td>
					<td><button class="k-button k-primary popsc-btn search-btn" type="button" onclick = "lfn_toolInfo('holder')">조회</button></td>
				</tr>
				<tr>
					<td><i class="fas fa-caret-right"></i>HOLDER 명칭 : </td>
					<td colspan="2"><input id="holderNm" name="holderNm" class="left-input" readonly/></td>
					<td class="td-right-title"><i class="fas fa-caret-right left-caret"></i>HOLDER 사양 : </td>
					<td colspan="2"><input id="holderDc" name="holderDc" class="right-input" readonly/></td>
				</tr>
				<tr>
					<td><i class="fas fa-caret-right"></i>INSERT DC : </td>
					<td colspan="2"><input id="insertDc" name="insertDc" class="left-input"/></td>
					<td class="td-right-title"><i class="fas fa-caret-right left-caret"></i>날수 : </td>
					<td colspan="2"><input id="insertQty" name="insertQty" class="right-input" format="currency"/></td>
				</tr>
				<tr><td colspan="6"></td></tr>
				<tr>
					<td><i class="fas fa-caret-right left-caret"></i>총 공구 길이 <b>(최대)</b> : </td>
					<td colspan="2"><input id="toolTLengthU" name="toolTLengthU" class="left-input" format="numeric"/></td>
					<td class="td-right-title"><i class="fas fa-caret-right left-caret"></i>총 공구 길이 <b>(최소)</b> : </td>					
					<td colspan="2"><input id="toolTLengthL" name="toolTLengthL" class="right-input" format="numeric"/></td>
				</tr>
				<tr>
					<td><i class="fas fa-caret-right"></i>날장 길이 <b>(최대)</b> : </td>
					<td colspan="2"><input id="toolWlengthU" name="toolWlengthU" class="left-input" format="numeric"/></td>
					<td class="td-right-title"><i class="fas fa-caret-right left-caret"></i>날장 길이 <b>(최소)</b> : </td>					
					<td colspan="2"><input id="toolWlengthL" name="toolWlengthL" class="right-input" format="numeric"/></td>
				</tr>
				<tr><td colspan="6"></td></tr>
				<tr>
					<td><i class="fas fa-caret-right"></i>교환주기 <b>(가공수량)</b> : </td>
					<td colspan="2"><input id="toolChange" name="toolChange" class="left-input" format="currency"/></td>
					<td class="td-right-title"><i class="fas fa-caret-right left-caret"></i>공구 직경 <b>(최소)</b> : </td>
					<td colspan="2"><input id="toolDia" name="toolDia" class="right-input" format="numeric"/></td>
				</tr>
				<tr>
					<td><i class="fas fa-caret-right"></i>OFFSET NO <b>(H)</b> : </td>
					<td colspan="2"><input id="offsetH" name="offsetH" class="left-input"/></td>
					<td class="td-right-title"><i class="fas fa-caret-right left-caret"></i>OFFSET NO <b>(D)</b> : </td>					
					<td colspan="2"><input id="offsetD" name="offsetD" class="right-input"/></td>
				</tr>
				<tr>
					<td><i class="fas fa-caret-right"></i>Special Note : </td>
					<td colspan="5"><input id="specialPic" name="specialPic" class="center-input"/></td>
				</tr>
			</table>
		</form>
...
<div style="display:none;">
	<div id="toolInfoForm" class="toolInfoForm"> <!-- MAVST > 차수 1에서 확인 가능_200806 youmi -->
		<form id="toolInfoForm_form" class="toolInfoFormForm mqsToolMgtForm mqsToolMgtForm_toolInfoFormForm" >
			<table id="toolInfoForm_master" class="toolInfoForm_master">  <!-- style="width:100%;" -->
				<colgroup>
				...
				<tr>
					<td><i class="fas fa-caret-right"></i>INSERT DC : </td>
					<td><input id="insertDc" name="insertDc" class="left-input" readonly/></td>
					<td class="td-right-title"><i class="fas fa-caret-right left-caret"></i>날수 : </td>
					<td><input id="insertQty" name="insertQty" class="right-input" readonly/></td>
				</tr>
				<tr><td colspan="4"></td></tr>
				<tr>
					<td><i class="fas fa-caret-right left-caret"></i>총 공구 길이 <b>(최대)</b> : </td>
					<td><input id="toolTLengthU" name="toolTLengthU" class="left-input" readonly/></td>
					<td class="td-right-title"><i class="fas fa-caret-right left-caret"></i>총 공구 길이 <b>(최소)</b> : </td>					
					<td><input id="toolTLengthL" name="toolTLengthL" class="right-input" readonly/></td>
				</tr>
				<tr>
					<td><i class="fas fa-caret-right"></i>날장 길이 <b>(최대)</b> : </td>
					<td><input id="toolWlengthU" name="toolWlengthU" class="left-input" readonly/></td>
					<td class="td-right-title"><i class="fas fa-caret-right left-caret"></i>날장 길이 <b>(최소)</b> : </td>					
					<td><input id="toolWlengthL" name="toolWlengthL" class="right-input" readonly/></td>
				</tr>
				<tr><td colspan="4"></td></tr>
				<tr>
					<td><i class="fas fa-caret-right"></i>교환주기 <b>(가공수량)</b> : </td>
					<td><input id="toolChange" name="toolChange" class="left-input" readonly/></td>
					<td class="td-right-title"><i class="fas fa-caret-right left-caret"></i>공구 직경 <b>(최소)</b> : </td>
					<td><input id="toolDia" name="toolDia" class="right-input" readonly/></td>
				</tr>
				<tr>
					<td><i class="fas fa-caret-right"></i>OFFSET NO <b>(H)</b> : </td>
					<td><input id="offsetH" name="offsetH" class="left-input" readonly/></td>
					<td class="td-right-title"><i class="fas fa-caret-right left-caret"></i>OFFSET NO <b>(D)</b> : </td>					
					<td><input id="offsetD" name="offsetD" class="right-input" readonly/></td>
				</tr>
				<tr>
					<td><i class="fas fa-caret-right"></i>Special Note : </td>
					<td colspan="3"><input id="specialPic" name="specialPic" class="center-input" readonly/></td>
				</tr>
			</table>
		</form>
	</div>
...
this.lfn_jteSgGrd_setGrd = function(){
	...
	*/
	...
	//3.
	lfo_common.ctrlUrl = "/cform/techMgt/mqsToolMgt";
...
this.lfn_toolListPop_setGrid = function(selectedItem){
	...
	//3.
	lfo_toolListGrd.ctrlUrl = "/cform/techMgt/mqsToolMgt";
