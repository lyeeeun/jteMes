	...
	<div id="equipment_info">
		<div class="processInfoForm equipment_info_div">
			<div class="k-widget k-header">
				<div class="routingMgtForm-pop search-area">
		...
		<div class="routingMgtForm-pop final-btn-area" style="text-align:center;">
			<button type="button" class="k-button k-primary final-btn" onclick = "lfn_rtlEquipmentSave('equipment_info')"><spring:message code = "pop_save"></spring:message></button>			<!-- 저장 -->
