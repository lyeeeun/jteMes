...
this.lfn_jteSgGrd_setGrd = function(){
	...
	lfo_common.columns = [
		...
		{field: "itemStdStr01", title : "부품규격", width: "240px"},											//예비1(Str)
		...
		{field: "itemUnit", template:"# var item = gfn_isNull(gfn_getCode(itemUnit))== true ? '기초코드 없음' : gfn_getMsg('bc_'+ gfn_getCode(itemUnit).cdId , gfn_getCode(itemUnit).cdNm) # #= item #",
			title:gfn_getMsg("col_unit"), width: "110px"},													//부품유형
...
this.lfn_jtePop_open = function(mode, selectedItem){
	...
	var options = {
			modal:true, 
			width: "700px", 
			height: "430px", //20.09.01 | ymlee | 530px : 신명  // 430px : 하나
			id:"jtePopForm", 
