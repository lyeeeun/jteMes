	...
	gfn_dialBox({msg:"선택한 공구로 부품을 생산한 수량을 입력하세요.(공구카운트 자동계산)", title:"공구사용정보", 
		yes : function(qtyObj){
			if(qtyObj.result != "DONE"){
				...
				$.ajax({
					async:false,
					url : "/cform/mfgMgt/wrkinWrkerMgt/setProdWorkAdminInsert",
					type: "POST",
					data: JSON.stringify(savePrmt),
					traditional :true,
					contentType : 'application/json',
	...
	gfn_dialBox({msg:"선택한 공구로 부품을 생산한 수량을 입력하세요.(공구카운트 자동계산)", title:"공구사용정보", 
		yes : function(qtyObj){
			...
			if(qtyObj.result != "DONE"){
				...
				$.ajax({
					async:false,
					url : "/cform/mfgMgt/wrkinWrkerMgt/setProdWorkAdminUpdate",
					type: "POST",
					data: JSON.stringify(savePrmt),
					traditional :true,
					contentType : 'application/json',
...
this.lfn_jtePopGrd_delete = function(resultObj){
	...
	$.ajax({
		async:false,
		url : "/cform/mfgMgt/wrkinWrkerMgt/setProdWorkAdminDelete",
		type: "POST",
