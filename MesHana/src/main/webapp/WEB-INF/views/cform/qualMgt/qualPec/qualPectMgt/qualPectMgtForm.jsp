...
this.lfn_jteSgGrd_setGrd = function(){
	...
	*/
	...
	//3.
	lfo_common.ctrlUrl = "/cform/qualMgt/qualPec/qualPectMgt"
	...
	lfo_common.columns = [
		...
		//{field: "mtrlOrderCost", format: "{0:n0}", title:gfn_getMsg("col_cost"), width: 100},
		//{field: "mtrlOrderDelivery", format: "{0:n0}", title:gfn_getMsg("col_deliveryCost"), width: 100},
...
*/
	...
	lfo_popGrd.columns = [
		...
		{field: "badQty",format: "{0:n0}", title : gfn_getMsg("col_badProdQuan"), width: "100px"},						//불량량
		{field: "chkUserNm", format: "{0:n0}", title : gfn_getMsg("col_inspector"), width: "100px"},					//검사자
