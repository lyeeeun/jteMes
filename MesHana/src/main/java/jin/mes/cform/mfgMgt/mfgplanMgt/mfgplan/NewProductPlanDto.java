...
@NoArgsConstructor
public class NewProductPlanDto  extends NewLotInfoDto {/**
	 * 
	 */
	private static final long serialVersionUID = 3301904692251069570L;
	
	public NewProductPlanDto(String prodPlanId, String prodPlanType, String prodPlanYear, String prodPlanMonth, String prodPlanDay, int prodPlanQty, String prodPlanDesc, String creatorId, String updatorId, String lotId) {
