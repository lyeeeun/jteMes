...
@NoArgsConstructor
public class NewMtrlHistoryDto extends BaseVo{/**
	 * 
	 */
	...
	public NewMtrlHistoryDto(String mtrlId, String mtrlQtyTarget, String mtrlQtyTargetCode, int mtrlQtyTotal, String mtrlQtyDate, String mtrlQtyUser,String mtrlMgtId, String lotId) {
		this.mtrlId = mtrlId;
