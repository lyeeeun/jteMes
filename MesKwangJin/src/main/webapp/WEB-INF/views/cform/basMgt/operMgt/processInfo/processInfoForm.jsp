	...
	<div id="jtePopForm">
		<form id="jtePopForm_form" class="processInfoForm">
			...
			<colgroup>
				...
				<tr>
					<td><i class="fas fa-caret-right"></i><spring:message code = "col_processCd"></spring:message> : </td>			<!-- 공정코드 -->	<!-- 201112 YUMI_th를 td로 변경 -->
					<td colspan="3"><input type="text" id="processId" name="processId" placeholder="<spring:message code = "pop_autoInput"></spring:message>" readonly/></td>			<!-- 자동입력 -->
				</tr>
				<tr>
					<td><i class="fas fa-caret-right"></i><spring:message code = "col_processNm"></spring:message> : </td>			<!-- 공정명 -->
					<td><input type="text" id="processNm" name="processNm" format="text"/></td>
					<td><i class="fas fa-caret-right"></i><spring:message code = "col_processType"></spring:message> : </td>		<!-- 공정유형 -->
					<td><input type="text" id="processType" name="processType" format="selBox"/></td>
				</tr>
				<tr>
					<td><i class="fas fa-caret-right"></i><spring:message code = "col_desc"></spring:message> : </td><td colspan="3"><input type="text" id="description" name="description" class="k-textbox"/></td>			<!-- 설명 -->
				</tr>
				<tr>
...
<div style="display:none;">
	<div id="equipment_info" class="processInfoForm">
		...
		<div class="processInfoForm final-btn-area" style="text-align:center;">
				<button type="button" class="k-button k-primary final-btn" onclick = "lfn_rtlEquipmentSave('equipment_info')"><spring:message code = "pop_save"></spring:message></button>		<!-- 저장 --> <!-- 201112 YUMI_스타일 적용을 위해 k-primary 클래스 추가 -->
				<button type="button" class="k-button k-primary final-btn" onclick = "gfn_closePop('equipment_info');"><spring:message code = "pop_cancel"></spring:message></button>			<!-- 취소 -->
		</div>
	</div>
</div> 
...
this.lfn_init = function(){
	...
	lfo_common.ctrlUrl ="/cform/basMgt/operMgt/processInfo";
...
this.lfn_jtePop_open = function(mode, selectedItem){
	var options = {
			modal:true, 
			width: "700px", 
			height: "318px", /** 200416 수정팝업 height 조정 LYM 290px / 201112 YUMI_290->315**/
			id:"jtePopForm", 
...
this.lfn_equipmentInfo = function(mode) {
	var options = {
			modal:true, 
			width: "600px", 
			height: "510px", /* 200518 팝업창 높이 변경 LYM 475px_JJW 500px_201112 YUMI 500->510 */
			id:"equipment_info", 
	...
	$.ajax({
		async:false,
		url : "/cform/basMgt/operMgt/facilMgt/getEqmtMgtListAll",
		type: "POST",
		data: "",
		success: function(data){
