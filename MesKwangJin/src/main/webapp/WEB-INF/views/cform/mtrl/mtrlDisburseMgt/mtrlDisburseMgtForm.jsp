...
this.lfn_jteSgGrd_setGrd = function(){
	...
	lfo_common.ctrlUrl = "/cform/mtrl/mtrlDisburseMgt";

	lfo_common.crud  = {
		read:{url:"/getMtrlDisburseMgtList", auth:"", prmt:{}, dynamicPrmt : {del : "delStat"}},  
		update:{url:"/setMtrlDisburseMgtSave", auth:"", openFunc : "", callback : lfn_popSave}
	};
...
this.lfn_jtePopGrd_setGrd = function(){
	...
	lfo_popGrd.ctrlUrl = "/cform/mtrl/mtrlDisburseMgt";

	lfo_popGrd.crud  = {
		read:{url:"/getMtrlDisburseHisList", auth:"", prmt : {mtrlMgtId : lfo_common.gridSelected.mtrlMgtId}}, 
