...
<div style="width:100%;">
	<div class="infergodsMgtForm search-btn-area" style="width:100%; background:#f0f5ff; padding:15px 0 15px 0; margin:10px 0 5px 0;">
		<input class="radio-btn" type="radio" name="target" value="mtrlPlate" ><span class="radio-span">판</span>
		<input class="radio-btn" type="radio" name="target" value="mtrlCasting" checked><span class="radio-span">주물</span>
	</div>
...
this.lfn_init = function(){
	//그리드 생성
	lfn_jteSgGrd_setGrd("mtrlCasting");
	lfn_radioBtn_event();
...
this.lfn_jteSgGrd_setGrd = function(sta){
	...
	lfo_common.crud  = {
		read:{url:"/getMtrlRecevingMgtList", auth:"", prmt:{mtrlStdStr03: sta}, dynamicPrmt : {del : "delStat"}}, 
