...
// 		{field: "deptNm", title:"부서명", width: 120},
		...
		{field: "prodWorkStart", template:"# var item = gfn_isNull(prodWorkStart)== true ? '작업대기' : gfn_isNull(prodWorkEnd) == true ? '진행중' : '작업완료' #  #= item #",
 		...
 		{field: "mtrUseInput", format:"{0:n0}", attributes : { style : "text-align : right;"}, title : gfn_getMsg("col_inputQuan"), width: "110px"},			//투입량
...
this.lfn_jteEquipToolPop_setGrd = function(){
	...
	lfo_equipTool.columns = [
		...
		{field: "toolMgtLimit", format:"{0:n0}", attributes : { style : "text-align : right;"}, title : gfn_getMsg("col_useLimit"), width: "120px"},							//사용한도
		{field: "toolUseQty", format:"{0:n0}", attributes : { style : "text-align : right;"}, title : gfn_getMsg("col_toolUse"), width: "120px"},								//사용량
		{field: "toolCount", format:"{0:n}", title : gfn_getMsg("col_feedrate"), width: "120px"},								//FEEDRATE
		{field: "toolRpm", format:"{0:n0}", attributes : { style : "text-align : right;"}, title : gfn_getMsg("col_toolRpm"), width: "120px"},									//RPM
