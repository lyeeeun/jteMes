	...
	<div id="jtePopForm" style="height:100%;">
		<form id="jtePopForm_form" class="productPlanForm">
			...
			<colgroup>
				...
				<tr>
					<td><i class="fas fa-caret-right"></i><spring:message code = "col_planQuan" text = "계획량"/> : </td>
		...
		<div class="final-btn-area" style="text-align:center;">
			<button class="k-button k-primary jte-save final-btn" type="button"><spring:message code = "pop_save" text = "저장"/></button>
		...
		<div id="asgnInfo" style="display:none;">
			<div class="pop_title"><spring:message code = "pop_workAsm" text = "작업지시"/></div>
...
this.lfn_jteDbGrd_setGrd = function(){
	...
	lfo_common.ctrlUrl = "/cform/mfgMgt/productPlan";
	...
	//6.
	lfo_common.columns = [
//		{field: "itemId", title:gfn_getMsg("col_itemCd", "제품코드"), width: "180px", locked: true},
		{field: "itemNm", title:gfn_getMsg("col_itemNm", "제품명"), width: "180px", locked: true},
		{field: "itemStdStr01", title : "규격", width: "120px", locked: true},
		{field: "planTotalQty", format: "{0:n0}", attributes : { style : "text-align : right;"}, title:gfn_getMsg("col_totalPlanQuan", "총 계획량"), width: "120px", locked: true},
		dayDataCol,
	];
	
	//7.
	lfo_common.selectBox = [
		{ text: gfn_getMsg("col_itemNm", "제품명"), value: "itemCal.itemNm" },
		{ text: gfn_getMsg("col_itemCd", "제품코드"), value: "itemCal.itemIId" }
	];
