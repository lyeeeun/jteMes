...
<script>
	...
	$(document).ready(function(){
		...
		//setTimeout(function(){$('#menuViewId_productWorkAdmin').click();}, 500);
		setTimeout(function(){$('#menuViewId_home').click();},500); //Main
		//setTimeout(function(){$('#menuViewId_inputQualMgt').click();}, 500);
		//setTimeout(function(){$('#menuViewId_orderDetailMgt').click();}, 500);
